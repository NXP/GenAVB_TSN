...
| `linux i.MX6ULL`       | `i.MX 6ULL`                                    |      x       |              |                |            |
| `linux i.MX8`          | `i.MX 8MM`                                     |      x       |              |                |            |
| `linux i.MX8`          | `i.MX 8MP`, `i.MX 8DXL`, `i.MX 93`             |      x       |      x       |                |            |
| `linux i.MX8`          | `i.MX 95` , `i.MX 943`                         |              |      x       |                |            |
| `linux i.MX8`          | `i.MX 8DXL + SJA1105Q`                         |              |              |        x       |            |
| `linux i.MX8`          | `i.MX 93 + SJA1105Q`                           |              |              |        x       |     x      |
| `linux LS1028`         | `LS1028A`                                      |              |              |        x       |            |
| `freertos RT1052`      | `i.MX RT1052`                                  |    **O**     |              |                |            |
| `freertos RT1176`      | `i.MX RT1176`                                  |    **O**     |    **O**     |                |            |
| `freertos RT1186 M33`  | `i.MX RT1186`                                  |              |    **O**     |      **O**     |            |
| `freertos RT1186 M7 `  | `i.MX RT1186`                                  |              |    **O**     |                |            |
| `freertos RT1189 M33`  | `i.MX RT1189`                                  |              |    **O**     |      **O**     |            |
| `freertos RT1189 M7 `  | `i.MX RT1189`                                  |              |    **O**     |                |            |
| `freertos MCXE247`     | `MCX E247`                                     |              |    **O**(a)  |                |            |
| `freertos MCXE31B`     | `MCX E31B`                                     |              |    **O**     |                |            |
| `freertos i.MX8MM A53` | `i.MX 8MM`                                     |      x       |      x       |                |            |
| `freertos i.MX8MN A53` | `i.MX 8MN`                                     |      x       |      x       |                |            |
| `freertos i.MX8MP A53` | `i.MX 8MP`                                     |      x       |      x       |                |            |
| `freertos i.MX93  A55` | `i.MX 93`                                      |      x       |      x       |                |            |
| `freertos i.MX95  A55` | `i.MX 95`                                      |              |      x       |                |            |
| `zephyr i.MX8MM A53`   | `i.MX 8MM`                                     |      x       |      x       |                |            |
| `zephyr i.MX8MN A53`   | `i.MX 8MN`                                     |      x       |      x       |                |            |
| `zephyr i.MX8MP A53`   | `i.MX 8MP`                                     |      x       |      x       |                |            |
| `zephyr i.MX93  A55`   | `i.MX 93`                                      |      x       |      x       |                |            |
| `zephyr i.MX95  A55`   | `i.MX 95`                                      |              |      x       |                |            |
...
The CMake build system must also be set. Two options are possible:
...
#### MCUX SDK 3.0 cmake configuration
```
set(MCUX_SDK_NG "/path/to/freertos_MCUXpresso_SDK" CACHE PATH "Path to MCUXpresso SDK")
set(RTOS_APPS "/path/to/freertos_application" CACHE PATH "Path to FreeRTOS application repository")
set(RTOS_ABSTRACTION_LAYER_DIR "/path/to/rtos-abstraction-layer/freertos" CACHE PATH "Path to RTOS Abstraction Layer repository, freertos directory")
```

This can only be done using the local config cmake file.
