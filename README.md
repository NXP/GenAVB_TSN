...
### AVB support
AVB Bridge and Endpoint configurations were supported and validated in previous releases, with the latest release being [GenAVB/TSN 8.1](https://github.com/NXP/GenAVB_TSN/releases/tag/8_1_0)
...
| Compilation target     | Hardware target                                | TSN endpoint | TSN bridge | AVB endpoint | AVB bridge |
| :--------------------: | :--------------------------------------------: | :----------: | :--------: |:-----------: | :--------: |
| `linux i.MX8`          | `i.MX 8MP`, `i.MX 8DXL`, `i.MX 93`             |    **O**     |            |      x       |            |
| `linux i.MX8`          | `i.MX 95` , `i.MX 943`                         |    **O**     |            |              |            |
| `linux LS1028`         | `LS1028A`                                      |              |   **O**    |              |     x      |
| `freertos RT1176`      | `i.MX RT1176`                                  |      x       |            |              |            |
| `freertos RT1186 M33`  | `i.MX RT1186`                                  |      x       |     x      |              |     x      |
| `freertos RT1186 M7 `  | `i.MX RT1186`                                  |      x       |            |              |            |
| `freertos RT1189 M33`  | `i.MX RT1189`                                  |      x       |     x      |              |     x      |
| `freertos RT1189 M7 `  | `i.MX RT1189`                                  |      x       |            |              |            |
| `freertos MCXE247`     | `MCX E247`                                     |      x(a)    |            |              |            |
| `freertos MCXE31B`     | `MCX E31B`                                     |      x       |            |              |            |
| `zephyr RT1189 M33`    | `i.MX RT1189`                                  |              |     x      |              |     x      |
| `zephyr RT1189 M7 `    | `i.MX RT1189`                                  |      x       |            |              |            |

(a) gPTP only endpoint
...
- Zephyr builds require additional NXP software. Refer to [Zephyr TSN Applications Software](https://github.com/nxp-zephyr/zephyr-tsn-apps) for reference.
...
The CMake build system must also be set:
...
Refer to [Zephyr TSN Applications Software](https://github.com/nxp-zephyr/zephyr-tsn-apps) for example applications.
...
#### Zephyr
Refer to the [Zephyr TSN applications README.md](https://github.com/nxp-zephyr/zephyr-tsn-apps/blob/main/README.md).
