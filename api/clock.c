...
static const os_clock_id_t public_clock_to_os_clock[] = {
	...
	[GENAVB_CLOCK_AVTP_0] = OS_CLOCK_AVTP_MEDIA_0,
	[GENAVB_CLOCK_AVTP_1] = OS_CLOCK_AVTP_MEDIA_1,
};

static const genavb_clock_id_t os_clock_to_public_clock[] = {
	[OS_CLOCK_SYSTEM_MONOTONIC] = GENAVB_CLOCK_MONOTONIC,
	[OS_CLOCK_GPTP_EP_0_0] = GENAVB_CLOCK_GPTP_0_0,
	[OS_CLOCK_GPTP_EP_0_1] = GENAVB_CLOCK_GPTP_0_1,
	[OS_CLOCK_GPTP_EP_1_0] = GENAVB_CLOCK_GPTP_1_0,
	[OS_CLOCK_GPTP_EP_1_1] = GENAVB_CLOCK_GPTP_1_1,
	[OS_CLOCK_GPTP_BR_0_0] = GENAVB_CLOCK_BR_0_0,
	[OS_CLOCK_GPTP_BR_0_1] = GENAVB_CLOCK_BR_0_1,
	[OS_CLOCK_LOCAL_BR_0] = GENAVB_CLOCK_LOCAL_BR_0,
	[OS_CLOCK_AVTP_MEDIA_0] = GENAVB_CLOCK_AVTP_0,
	[OS_CLOCK_AVTP_MEDIA_1] = GENAVB_CLOCK_AVTP_1,
};
...
{
	if (id >= OS_CLOCK_MAX)
		return GENAVB_CLOCK_MAX;

	return os_clock_to_public_clock[id];
}
