...
int genavb_socket_rx_set_callback(struct genavb_socket_rx *sock, void (*callback)(void *data), void *data)
{
	int rc;
...
int genavb_socket_tx_set_callback(struct genavb_socket_tx *sock, void (*callback)(void *data), void *data)
{
	int rc;
