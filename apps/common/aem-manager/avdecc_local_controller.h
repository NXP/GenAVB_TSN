...
#define AEM_ENTITY_MODEL_ID				0x00049f0000080002 /* to be incremented by one upon change in the structure of entity model  - 17722_1-6.2.1.9 */


/* Entity config */
#define AEM_CFG_ENTITY_NAME				"NXP AVB local controller"
...
#define AEM_CFG_ENTITY_CAPABILITIES			(ADP_ENTITY_AEM_SUPPORTED | ADP_ENTITY_AEM_CONFIGURATION_INDEX_VALID)  /* FIXME Needed or not for a controller? */
#define AEM_CFG_ENTITY_TALKER_CAPABILITIES		0
#define AEM_CFG_ENTITY_LISTENER_CAPABILITIES		0
#define AEM_CFG_ENTITY_CONTROLLER_CAPABILITIES		(ADP_CONTROLLER_IMPLEMENTED | ADP_CONTROLLER_LOCALLY_VISIBLE)
