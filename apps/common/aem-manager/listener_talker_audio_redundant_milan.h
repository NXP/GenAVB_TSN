...
#ifndef _LISTENER_TALKER_AUDIO_REDUNDANT_MILAN_H_
#define _LISTENER_TALKER_AUDIO_REDUNDANT_MILAN_H_

#define AEM_ENTITY_MODEL_ID				0x00049f00000f0001 /* to be incremented by one upon change in the structure of entity model  - 17722_1-6.2.1.9 */


/* Entity config */
#define AEM_CFG_ENTITY_NAME				"NXP AVB Milan device"
...
#define AEM_CFG_ENTITY_CAPABILITIES                     (ADP_ENTITY_CLASS_A_SUPPORTED | ADP_ENTITY_GPTP_SUPPORTED | ADP_ENTITY_AEM_SUPPORTED | ADP_ENTITY_VENDOR_UNIQUE_SUPPORTED | ADP_ENTITY_AEM_INTERFACE_INDEX_VALID | ADP_ENTITY_AEM_CONFIGURATION_INDEX_VALID)
...
#define AEM_CFG_AUDIO_UNIT_BASE_CONTROLS_0		1
...
/* Stream input config */
#define AEM_CFG_STREAM_INPUT_FORMAT_0			0x0205022000406000 //7.3.2 AAF 1chan  32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_INPUT_FORMAT_1			0x0205022000806000 //7.3.2 AAF 2chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_INPUT_FORMAT_2			0x0205022001006000 //7.3.2 AAF 4chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_INPUT_FORMAT_3			0x0205022001806000 //7.3.2 AAF 6chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_INPUT_FORMAT_4			0x0205022002006000 //7.3.2 AAF 8chans 32/32bits 48kHz 6samples/packet


#define AEM_CFG_STREAM_INPUT_NAME_0			"Stream input 0 (Primary Audio)"
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_0		AEM_CFG_STREAM_INPUT_FORMAT_1
#define AEM_CFG_STREAM_INPUT_NB_FORMATS_0		5
...
#define AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_0	1
#define AEM_CFG_STREAM_INPUT_FORMATS_0	{	\
						htonll(AEM_CFG_STREAM_INPUT_FORMAT_0), htonll(AEM_CFG_STREAM_INPUT_FORMAT_1), htonll(AEM_CFG_STREAM_INPUT_FORMAT_2), \
						htonll(AEM_CFG_STREAM_INPUT_FORMAT_3), htonll(AEM_CFG_STREAM_INPUT_FORMAT_4), \
					}
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_0	{ htons(1) }

#define AEM_CFG_STREAM_INPUT_NAME_1			"Stream input 1 (Secondary Audio)"
...
#define AEM_CFG_STREAM_INPUT_AVB_ITF_INDEX_1		1
#define AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_1		AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_0
#define AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_1	AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_0
#define AEM_CFG_STREAM_INPUT_FORMATS_1			AEM_CFG_STREAM_INPUT_FORMATS_0
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_1	{ htons(0) }

#define AEM_CFG_STREAM_INPUT_NAME_2			"Stream input 2 (Primary Clock)"
#define AEM_CFG_STREAM_INPUT_LOC_DESC_2			7
#define AEM_CFG_STREAM_INPUT_CLOCK_DOMAIN_IDX_2		0
#define AEM_CFG_STREAM_INPUT_STREAM_FLAGS_2		(AEM_STREAM_FLAG_CLASS_A)
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_2		0x041060010000BB80 //7.3.2 CRF, 48kHz, 96 timestamp interval, 1 timestamp/packet
#define AEM_CFG_STREAM_INPUT_NB_FORMATS_2		1
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_0_2	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_0_2	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_1_2	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_1_2	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_2_2	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_2_2	0
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_ENTITY_2	0
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_UNIQUE_2	0
#define AEM_CFG_STREAM_INPUT_AVB_ITF_INDEX_2		0
#define AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_2		64000000 // 32 buffers as socket queue size
#define AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_2	1
#define AEM_CFG_STREAM_INPUT_FORMATS_2			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_2) }
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_2	{ htons(3) }

#define AEM_CFG_STREAM_INPUT_NAME_3			"Stream input 3 (Secondary Clock)"
#define AEM_CFG_STREAM_INPUT_LOC_DESC_3			AEM_CFG_STREAM_INPUT_LOC_DESC_2
#define AEM_CFG_STREAM_INPUT_CLOCK_DOMAIN_IDX_3		AEM_CFG_STREAM_INPUT_CLOCK_DOMAIN_IDX_2
#define AEM_CFG_STREAM_INPUT_STREAM_FLAGS_3		AEM_CFG_STREAM_INPUT_STREAM_FLAGS_2
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_3		AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_2
#define AEM_CFG_STREAM_INPUT_NB_FORMATS_3		AEM_CFG_STREAM_INPUT_NB_FORMATS_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_0_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_0_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_0_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_0_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_1_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_1_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_1_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_1_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_2_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_2_2
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_2_3	AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_2_2
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_ENTITY_3	AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_ENTITY_2
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_UNIQUE_3	AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_UNIQUE_2
#define AEM_CFG_STREAM_INPUT_AVB_ITF_INDEX_3		1
#define AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_3		AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_2
#define AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_3	AEM_CFG_STREAM_INPUT_NB_REDUNDANT_STREAMS_2
#define AEM_CFG_STREAM_INPUT_FORMATS_3			AEM_CFG_STREAM_INPUT_FORMATS_2
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_3	{ htons(2) }


#define AEM_CFG_STREAM_INPUT_DESCRIPTORS {	\
						AEM_CFG_STREAM_INPUT_DESCRIPTOR(0), AEM_CFG_STREAM_INPUT_DESCRIPTOR(1), \
						AEM_CFG_STREAM_INPUT_DESCRIPTOR(2), AEM_CFG_STREAM_INPUT_DESCRIPTOR(3), \
					}


/* Stream output config */
#define AEM_CFG_STREAM_OUTPUT_FORMAT_0			0x0205022000406000 //7.3.2 AAF 1chan  32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_OUTPUT_FORMAT_1			0x0205022000806000 //7.3.2 AAF 2chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_OUTPUT_FORMAT_2			0x0205022001006000 //7.3.2 AAF 4chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_OUTPUT_FORMAT_3			0x0205022001806000 //7.3.2 AAF 6chans 32/32bits 48kHz 6samples/packet
#define AEM_CFG_STREAM_OUTPUT_FORMAT_4			0x0205022002006000 //7.3.2 AAF 8chans 32/32bits 48kHz 6samples/packet


#define AEM_CFG_STREAM_OUTPUT_NAME_0			"Stream output 0 (Primary Audio)"
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_0		AEM_CFG_STREAM_OUTPUT_FORMAT_1
#define AEM_CFG_STREAM_OUTPUT_NB_FORMATS_0		5
...
#define AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_0	1
#define AEM_CFG_STREAM_OUTPUT_FORMATS_0	{	\
						htonll(AEM_CFG_STREAM_OUTPUT_FORMAT_0), htonll(AEM_CFG_STREAM_OUTPUT_FORMAT_1), htonll(AEM_CFG_STREAM_OUTPUT_FORMAT_2), \
						htonll(AEM_CFG_STREAM_OUTPUT_FORMAT_3), htonll(AEM_CFG_STREAM_OUTPUT_FORMAT_4), \
					}
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_0	{ htons(1) }

#define AEM_CFG_STREAM_OUTPUT_NAME_1			"Stream output 1 (Secondary Audio)"
...
#define AEM_CFG_STREAM_OUTPUT_AVB_ITF_INDEX_1		1
#define AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_1		AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_0
#define AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_1	AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_0
#define AEM_CFG_STREAM_OUTPUT_FORMATS_1			AEM_CFG_STREAM_OUTPUT_FORMATS_0
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_1	{ htons(0) }

#define AEM_CFG_STREAM_OUTPUT_NAME_2			"Stream output 2 (Primary Clock)"
#define AEM_CFG_STREAM_OUTPUT_LOC_DESC_2		7
#define AEM_CFG_STREAM_OUTPUT_CLOCK_DOMAIN_IDX_2	0
#define AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_2		(AEM_STREAM_FLAG_CLASS_A)
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_2		0x041060010000BB80 //7.3.2 CRF, 48kHz, 96 timestamp interval, 1 timestamp/packet
#define AEM_CFG_STREAM_OUTPUT_NB_FORMATS_2		1
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_0_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_0_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_1_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_1_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_2_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_2_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_ENTITY_2	0
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_UNIQUE_2	0
#define AEM_CFG_STREAM_OUTPUT_AVB_ITF_INDEX_2		0
#define AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_2		0
#define AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_2	1
#define AEM_CFG_STREAM_OUTPUT_FORMATS_2			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_2) }
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_2	{ htons(3) }

#define AEM_CFG_STREAM_OUTPUT_NAME_3			"Stream output 3 (Secondary Clock)"
#define AEM_CFG_STREAM_OUTPUT_LOC_DESC_3		AEM_CFG_STREAM_OUTPUT_LOC_DESC_2
#define AEM_CFG_STREAM_OUTPUT_CLOCK_DOMAIN_IDX_3	AEM_CFG_STREAM_OUTPUT_CLOCK_DOMAIN_IDX_2
#define AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_3		AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_2
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_3		AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_2
#define AEM_CFG_STREAM_OUTPUT_NB_FORMATS_3		AEM_CFG_STREAM_OUTPUT_NB_FORMATS_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_0_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_0_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_0_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_0_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_1_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_1_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_1_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_1_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_2_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_2_2
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_2_3	AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_2_2
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_ENTITY_3	AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_ENTITY_2
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_UNIQUE_3	AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_UNIQUE_2
#define AEM_CFG_STREAM_OUTPUT_AVB_ITF_INDEX_3		1
#define AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_3		AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_2
#define AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_3	AEM_CFG_STREAM_OUTPUT_NB_REDUNDANT_STREAMS_2
#define AEM_CFG_STREAM_OUTPUT_FORMATS_3			AEM_CFG_STREAM_OUTPUT_FORMATS_2
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_3	{ htons(2) }


#define AEM_CFG_STREAM_OUTPUT_DESCRIPTORS {	\
						AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(0), AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(1), \
						AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(2), AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(3), \
					}
...
#define AEM_CFG_AVB_ITF_NAME_0			"AVB Primary Interface"
...
#define AEM_CFG_AVB_ITF_NAME_1			"AVB Secondary Interface"
#define AEM_CFG_AVB_ITF_LOC_DESC_1		AEM_CFG_AVB_ITF_LOC_DESC_0
#define AEM_CFG_AVB_ITF_ITF_FLAGS_1		AEM_CFG_AVB_ITF_ITF_FLAGS_0
#define AEM_CFG_AVB_ITF_CLOCK_ID_1		AEM_CFG_AVB_ITF_CLOCK_ID_0
#define AEM_CFG_AVB_ITF_PRIO1_1			AEM_CFG_AVB_ITF_PRIO1_0
#define AEM_CFG_AVB_ITF_CLOCK_CLASS_1		AEM_CFG_AVB_ITF_CLOCK_CLASS_0
#define AEM_CFG_AVB_ITF_OFF_SCALED_VAR_1	AEM_CFG_AVB_ITF_OFF_SCALED_VAR_0
#define AEM_CFG_AVB_ITF_CLOCK_ACCURACY_1	AEM_CFG_AVB_ITF_CLOCK_ACCURACY_0
#define AEM_CFG_AVB_ITF_PRIO2_1			AEM_CFG_AVB_ITF_PRIO2_0
#define AEM_CFG_AVB_ITF_DOMAIN_NB_1		AEM_CFG_AVB_ITF_DOMAIN_NB_0
#define AEM_CFG_AVB_ITF_LOG_SYN_INTER_1		AEM_CFG_AVB_ITF_LOG_SYN_INTER_0
#define AEM_CFG_AVB_ITF_LOG_ANN_INTER_1		AEM_CFG_AVB_ITF_LOG_ANN_INTER_0
#define AEM_CFG_AVB_ITF_POG_PDEL_INTER_1	AEM_CFG_AVB_ITF_POG_PDEL_INTER_0
#define AEM_CFG_AVB_ITF_PORT_NB_1		AEM_CFG_AVB_ITF_PORT_NB_0


#define AEM_CFG_AVB_ITF_DESCRIPTORS {AEM_CFG_AVB_ITF_DESCRIPTOR(0), AEM_CFG_AVB_ITF_DESCRIPTOR(1)}


/* Clock source config */
#define AEM_CFG_CLK_SOURCE_NAME_0		"Clock source 0 (Internal)"
...
#define AEM_CFG_CLK_SOURCE_NAME_1		"Clock source 1 (Stream Input Primary CRF)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_1		7
#define AEM_CFG_CLK_SOURCE_FLAGS_1		AEM_CLOCK_SOURCE_FLAGS_STREAM_ID
#define AEM_CFG_CLK_SOURCE_TYPE_1		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_1			1
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_1		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_1		2

#define AEM_CFG_CLK_SOURCE_NAME_2		"Clock source 2 (Stream Input Secondary CRF)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_2		7
#define AEM_CFG_CLK_SOURCE_FLAGS_2		AEM_CLOCK_SOURCE_FLAGS_STREAM_ID
#define AEM_CFG_CLK_SOURCE_TYPE_2		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_2			2
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_2		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_2		3

#define AEM_CFG_CLK_SOURCE_NAME_3		"Clock source 3 (Stream Input Primary AAF)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_3		7
#define AEM_CFG_CLK_SOURCE_FLAGS_3		AEM_CLOCK_SOURCE_FLAGS_STREAM_ID
#define AEM_CFG_CLK_SOURCE_TYPE_3		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_3			3
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_3		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_3		0

#define AEM_CFG_CLK_SOURCE_NAME_4		"Clock source 4 (Stream Input Secondary AAF)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_4		7
#define AEM_CFG_CLK_SOURCE_FLAGS_4		AEM_CLOCK_SOURCE_FLAGS_STREAM_ID
#define AEM_CFG_CLK_SOURCE_TYPE_4		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_4			4
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_4		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_4		1

#define AEM_CFG_CLK_SOURCE_DESCRIPTORS {	\
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(0), AEM_CFG_CLK_SOURCE_DESCRIPTOR(1), \
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(2), AEM_CFG_CLK_SOURCE_DESCRIPTOR(3), \
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(4), \
					}
...
#define AEM_CFG_CLK_DOMAIN_SOURCES_COUNT_0	5
#define AEM_CFG_CLK_DOMAIN_SOURCES_0		{htons(0), htons(1), htons(2), htons(3), htons(4)}
...
#define AEM_CFG_STREAM_PORT_OUT_BASE_CLUSTER_0		2
#define AEM_CFG_STREAM_PORT_OUT_NB_MAPS_0		2
...
#define AEM_CFG_AUDIO_CLUSTER_LOC_DESC_2		7
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_TYPE_2		AEM_DESC_TYPE_EXTERNAL_PORT_INPUT
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_IDX_2		0
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_OUTPUT_2		0
#define AEM_CFG_AUDIO_CLUSTER_PATH_LAT_2		0
#define AEM_CFG_AUDIO_CLUSTER_BLOCK_LAT_2		0
#define AEM_CFG_AUDIO_CLUSTER_CHAN_COUNT_2		1
#define AEM_CFG_AUDIO_CLUSTER_FORMAT_2			AEM_AUDIO_CLUSTER_FORMAT_MBLA

#define AEM_CFG_AUDIO_CLUSTER_NAME_3			"Audio cluster 3"
#define AEM_CFG_AUDIO_CLUSTER_LOC_DESC_3		7
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_TYPE_3		AEM_DESC_TYPE_EXTERNAL_PORT_INPUT
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_IDX_3		1
#define AEM_CFG_AUDIO_CLUSTER_SIGNAL_OUTPUT_3		0
#define AEM_CFG_AUDIO_CLUSTER_PATH_LAT_3		0
#define AEM_CFG_AUDIO_CLUSTER_BLOCK_LAT_3		0
#define AEM_CFG_AUDIO_CLUSTER_CHAN_COUNT_3		1
#define AEM_CFG_AUDIO_CLUSTER_FORMAT_3			AEM_AUDIO_CLUSTER_FORMAT_MBLA

#define AEM_CFG_AUDIO_CLUSTER_DESCRIPTORS {AEM_CFG_AUDIO_CLUSTER_DESCRIPTOR(0), AEM_CFG_AUDIO_CLUSTER_DESCRIPTOR(1), AEM_CFG_AUDIO_CLUSTER_DESCRIPTOR(2), AEM_CFG_AUDIO_CLUSTER_DESCRIPTOR(3)}
...
#define AEM_CFG_AUDIO_MAP_NB_MAPPINGS_1		AEM_CFG_AUDIO_MAP_NB_MAPPINGS_0
...
#define AEM_CFG_CONTROL_NAME_0			"Identify"
#define AEM_CFG_CONTROL_LOC_DESC_0		7
#define AEM_CFG_CONTROL_BLOCK_LAT_0		0
#define AEM_CFG_CONTROL_CTRL_LAT_0		0
...
#define AEM_CFG_CONTROL_TYPE_0			AEM_CONTROL_TYPE_IDENTIFY
#define AEM_CFG_CONTROL_RESET_TIME_0		0
#define AEM_CFG_CONTROL_NB_VALUES_0		1
#define AEM_CFG_CONTROL_SIGNAL_TYPE_0		AEM_DESC_TYPE_INVALID
...
#define AEM_CFG_CONTROL_NAME_1			"Volume Control Channel 0"
...
#define AEM_CFG_CONTROL_NAME_2			"Volume Control Channel 1"
...
#define AEM_CFG_CONTROL_TYPE_2			AEM_CONTROL_TYPE_GAIN
...
#define AEM_CFG_CONTROL_SIGNAL_INDEX_2		1
...
#endif /* _LISTENER_TALKER_AUDIO_REDUNDANT_MILAN_H_ */
