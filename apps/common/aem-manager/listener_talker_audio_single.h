...
#ifndef _LISTENER_TALKER_AUDIO_SINGLE_H_
#define _LISTENER_TALKER_AUDIO_SINGLE_H_

#define AEM_ENTITY_MODEL_ID				0x00049f00000e0001 /* to be incremented by one upon change in the structure of entity model  - 17722_1-6.2.1.9 */
...
#define AEM_CFG_CLK_SOURCE_NAME_1		"Clock source 1 (Internal)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_1		7
#define AEM_CFG_CLK_SOURCE_FLAGS_1		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
#define AEM_CFG_CLK_SOURCE_TYPE_1		AEM_CLOCK_SOURCE_TYPE_INTERNAL
#define AEM_CFG_CLK_SOURCE_ID_1			1
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_1		0
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_1		0
...
#define AEM_CFG_CLK_DOMAIN_SOURCE_IDX_0		1
...
#endif /* _LISTENER_TALKER_AUDIO_SINGLE_H_ */
