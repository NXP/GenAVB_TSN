...
#ifndef _LISTENER_TALKER_AUDIO_SINGLE_MILAN_H_
#define _LISTENER_TALKER_AUDIO_SINGLE_MILAN_H_
...
/* Stream input config */
#define AEM_CFG_STREAM_INPUT_NAME_0			"Stream input 0 (Audio)"
...
#define AEM_CFG_STREAM_INPUT_NAME_1			"Stream input 1 (Clock)"
#define AEM_CFG_STREAM_INPUT_LOC_DESC_1			7
#define AEM_CFG_STREAM_INPUT_CLOCK_DOMAIN_IDX_1		0
#define AEM_CFG_STREAM_INPUT_STREAM_FLAGS_1		(AEM_STREAM_FLAG_CLASS_A)
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_1		0x041060010000BB80 //7.3.2 CRF, 48kHz, 96 timestamp interval, 1 timestamp/packet
#define AEM_CFG_STREAM_INPUT_NB_FORMATS_1		1
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_0_1	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_0_1	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_1_1	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_1_1	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_ENTITY_2_1	0
#define AEM_CFG_STREAM_INPUT_BACKUP_TALKER_UNIQUE_2_1	0
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_ENTITY_1	0
#define AEM_CFG_STREAM_INPUT_BACKEDUP_TALKER_UNIQUE_1	0
#define AEM_CFG_STREAM_INPUT_AVB_ITF_INDEX_1		0
#define AEM_CFG_STREAM_INPUT_BUFFER_LENGTH_1		64000000 // 32 buffers as socket queue size
...
#define AEM_CFG_STREAM_INPUT_DESCRIPTORS {AEM_CFG_STREAM_INPUT_DESCRIPTOR(0), AEM_CFG_STREAM_INPUT_DESCRIPTOR(1)}


/* Stream output config */
#define AEM_CFG_STREAM_OUTPUT_NAME_0			"Stream output 0 (Audio)"
...
#define AEM_CFG_STREAM_OUTPUT_NAME_1			"Stream output 1 (Clock)"
#define AEM_CFG_STREAM_OUTPUT_LOC_DESC_1		7
#define AEM_CFG_STREAM_OUTPUT_CLOCK_DOMAIN_IDX_1	0
#define AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_1		(AEM_STREAM_FLAG_CLASS_A)
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_1		0x041060010000BB80 //7.3.2 CRF, 48kHz, 96 timestamp interval, 1 timestamp/packet
#define AEM_CFG_STREAM_OUTPUT_NB_FORMATS_1		1
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_0_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_0_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_1_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_1_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_ENTITY_2_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKUP_TALKER_UNIQUE_2_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_ENTITY_1	0
#define AEM_CFG_STREAM_OUTPUT_BACKEDUP_TALKER_UNIQUE_1	0
#define AEM_CFG_STREAM_OUTPUT_AVB_ITF_INDEX_1		0
#define AEM_CFG_STREAM_OUTPUT_BUFFER_LENGTH_1		0
...
#define AEM_CFG_STREAM_OUTPUT_DESCRIPTORS {AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(0), AEM_CFG_STREAM_OUTPUT_DESCRIPTOR(1)}
...
#define AEM_CFG_CLK_SOURCE_NAME_1		"Clock source 1 (Stream Input CRF)"
...
#define AEM_CFG_CLK_SOURCE_NAME_2		"Clock source 2 (Stream Input AAF)"
...
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_2		0

#define AEM_CFG_CLK_SOURCE_DESCRIPTORS {AEM_CFG_CLK_SOURCE_DESCRIPTOR(0), AEM_CFG_CLK_SOURCE_DESCRIPTOR(1), AEM_CFG_CLK_SOURCE_DESCRIPTOR(2)}
...
#define AEM_CFG_CLK_DOMAIN_SOURCES_COUNT_0	3
#define AEM_CFG_CLK_DOMAIN_SOURCES_0		{htons(0), htons(1), htons(2)}
...
#define AEM_CFG_MEMORY_OBJECT_NAME_0			"NXP logo (PNG)"
#define AEM_CFG_MEMORY_OBJECT_LOC_DESC_0		7
#define AEM_CFG_MEMORY_OBJECT_TYPE_0			AEM_MEMORY_OBJECT_PNG_ENTITY
#define AEM_CFG_MEMORY_OBJECT_TARGET_DESC_TYPE_0	AEM_DESC_TYPE_ENTITY
#define AEM_CFG_MEMORY_OBJECT_TARGET_DESC_INDEX_0	0

#define AEM_CFG_MEMORY_OBJECT_DESCRIPTORS {AEM_CFG_MEMORY_OBJECT_DESCRIPTOR(0)}

#include "genavb/aem_entity.h"

#endif /* _LISTENER_TALKER_AUDIO_SINGLE_MILAN_H_ */
