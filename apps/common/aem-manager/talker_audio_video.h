...
#ifndef _TALKER_AUDIO_VIDEO_H_
#define _TALKER_AUDIO_VIDEO_H_

#define AEM_ENTITY_MODEL_ID				0x00049f0000050001 /* to be incremented by one upon change in the structure of entity model  - 17722_1-6.2.1.9 */
...
#define AEM_CFG_ENTITY_CAPABILITIES			(ADP_ENTITY_CLASS_A_SUPPORTED | ADP_ENTITY_CLASS_B_SUPPORTED | ADP_ENTITY_GPTP_SUPPORTED | ADP_ENTITY_AEM_SUPPORTED | ADP_ENTITY_ASSOCIATION_ID_SUPPORTED | ADP_ENTITY_ASSOCIATION_ID_VALID | ADP_ENTITY_AEM_CONFIGURATION_INDEX_VALID)
#define AEM_CFG_ENTITY_TALKER_CAPABILITIES		(ADP_TALKER_AUDIO_SOURCE | ADP_TALKER_VIDEO_SOURCE | ADP_TALKER_MEDIA_CLOCK_SOURCE | ADP_TALKER_IMPLEMENTED)
...
#define AEM_CFG_VIDEO_UNIT_BASE_STREAM_OUT_PORT_0	1
#define AEM_CFG_VIDEO_UNIT_NB_EXT_IN_PORT_0		1
#define AEM_CFG_VIDEO_UNIT_BASE_EXT_IN_PORT_0		1
...
#define AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_1		(AEM_STREAM_FLAG_CLASS_A | AEM_STREAM_FLAG_CLASS_B)
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_1		0x00C0000000000000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_1			{ htonll(0x00C0000000000000) }
...
#define AEM_CFG_STREAM_OUTPUT_STREAM_FLAGS_2           (AEM_STREAM_FLAG_CLASS_A |AEM_STREAM_FLAG_CLASS_B)
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_2         0x0302010000000000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_2                { htonll(0x0302010000000000) }
...
#define AEM_CFG_JACK_INPUT_DESCRIPTORS {AEM_CFG_JACK_INPUT_DESCRIPTOR(0), AEM_CFG_JACK_INPUT_DESCRIPTOR(1)}
...
#define AEM_CFG_STREAM_PORT_OUT_CLK_DOM_IDX_1		0
#define AEM_CFG_STREAM_PORT_OUT_PORT_FLAGS_1		0
#define AEM_CFG_STREAM_PORT_OUT_NB_CONTROLS_1		0
#define AEM_CFG_STREAM_PORT_OUT_BASE_CONTROL_1		0
#define AEM_CFG_STREAM_PORT_OUT_NB_CLUSTERS_1		2
#define AEM_CFG_STREAM_PORT_OUT_BASE_CLUSTER_1		0
#define AEM_CFG_STREAM_PORT_OUT_NB_MAPS_1		1
#define AEM_CFG_STREAM_PORT_OUT_BASE_MAP_1		0

#define AEM_CFG_STREAM_PORT_OUT_DESCRIPTORS {AEM_CFG_STREAM_PORT_OUT_DESCRIPTOR(0),AEM_CFG_STREAM_PORT_OUT_DESCRIPTOR(1)}
...
#define AEM_CFG_AUDIO_CLUSTER_DESCRIPTORS {AEM_CFG_AUDIO_CLUSTER_DESCRIPTOR(0)}
...
/* Control for media track number (0 to 255) */
#define AEM_CFG_CONTROL_NAME_3			"Media track name\0"
#define AEM_CFG_CONTROL_LOC_DESC_3		7
#define AEM_CFG_CONTROL_BLOCK_LAT_3		0
#define AEM_CFG_CONTROL_CTRL_LAT_3		200
#define AEM_CFG_CONTROL_DOMAIN_3		0
#define AEM_CFG_CONTROL_VALUE_TYPE_3		AEM_CONTROL_SET_VALUE_TYPE(1, 0, AEM_CONTROL_UTF8)
#define AEM_CFG_CONTROL_TYPE_3			AEM_CONTROL_TYPE_MEDIA_TRACK_NAME
#define AEM_CFG_CONTROL_RESET_TIME_3		0
#define AEM_CFG_CONTROL_NB_VALUES_3		1
#define AEM_CFG_CONTROL_SIGNAL_TYPE_3		AEM_DESC_TYPE_AUDIO_CLUSTER
#define AEM_CFG_CONTROL_SIGNAL_INDEX_3		0
#define AEM_CFG_CONTROL_SIGNAL_OUTPUT_3		0
#define AEM_CFG_CONTROL_VALUE_DETAILS_3		{\
		.utf8.string = "Undefined\0" }


#define AEM_CFG_CONTROL_DESCRIPTORS {AEM_CFG_CONTROL_DESCRIPTOR(0), AEM_CFG_CONTROL_DESCRIPTOR(1), AEM_CFG_CONTROL_DESCRIPTOR(2), AEM_CFG_CONTROL_DESCRIPTOR(3)}

#include "genavb/aem_entity.h"

#endif /* _TALKER_AUDIO_VIDEO_H_ */
