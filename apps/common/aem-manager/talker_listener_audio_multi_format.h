/*
 * Copyright 2016-2020, 2022, 2024-2026 NXP
 *
 * SPDX-License-Identifier: BSD-3-Clause
 */

#ifndef _TALKER_LISTENER_AUDIO_MULTI_FORMAT_H_
#define _TALKER_LISTENER_AUDIO_MULTI_FORMAT_H_

#define AEM_ENTITY_MODEL_ID				0x00049f0000070001 /* to be incremented by one upon change in the structure of entity model  - 17722_1-6.2.1.9 */
...
#define AEM_CFG_ENTITY_CAPABILITIES			(ADP_ENTITY_CLASS_A_SUPPORTED | ADP_ENTITY_CLASS_B_SUPPORTED | ADP_ENTITY_GPTP_SUPPORTED | ADP_ENTITY_AEM_SUPPORTED | ADP_ENTITY_AEM_CONFIGURATION_INDEX_VALID)
...
/* Stream input config */
#define AEM_CFG_STREAM_INPUT_NAME_0			"Stream input 0" // 61883-6 - 48000Hz
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_0		0x00A0020240000200 //7.3.2
...
#define AEM_CFG_STREAM_INPUT_NAME_1			"Stream input 1" // 61883-6 - 96000Hz
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_1		0x00A0040240000200
...
#define AEM_CFG_STREAM_INPUT_NAME_2			"Stream input 2" // AAF - 48000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_2		0x0205021800806000
...
#define AEM_CFG_STREAM_INPUT_NAME_3			"Stream input 3" // AAF - 48000Hz - SR CLASS B
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_3		0x020502180080C000
...
#define AEM_CFG_STREAM_INPUT_FORMATS_3			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_3) }
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_3        { 0 }

#define AEM_CFG_STREAM_INPUT_NAME_4			"Stream input 4" // AAF - 48000Hz - SR CLASS C
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_4		0x0205021800840000
...
#define AEM_CFG_STREAM_INPUT_FORMATS_4			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_4) }
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_4        { 0 }

#define AEM_CFG_STREAM_INPUT_NAME_5			"Stream input 5" // AAF - 48000Hz - SR CLASS E
...
#define AEM_CFG_STREAM_INPUT_FORMATS_5			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_5) }
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_5        { 0 }

#define AEM_CFG_STREAM_INPUT_NAME_6			"Stream input 6" // AAF - 96000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_6		0x020702180080C000
...
#define AEM_CFG_STREAM_INPUT_FORMATS_6			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_6) }
#define AEM_CFG_STREAM_INPUT_REDUNDANT_STREAMS_6        { 0 }

#define AEM_CFG_STREAM_INPUT_NAME_7			"Stream input 7" // AAF - 192000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_7		0x0209021800818000
...
#define AEM_CFG_STREAM_INPUT_FORMATS_7			{ htonll(AEM_CFG_STREAM_INPUT_CURRENT_FORMAT_7) }
...
#define AEM_CFG_STREAM_OUTPUT_NAME_0			"Stream output 0" // 61883-6 - 48000Hz
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_0		0x00A0020240000200 //7.3.2
...
#define AEM_CFG_STREAM_OUTPUT_NAME_1			"Stream output 1" // 61883-6 - 96000Hz
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_1		0x00A0040240000200
...
#define AEM_CFG_STREAM_OUTPUT_NAME_2			"Stream output 2" // AAF - 48000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_2		0x0205021800806000
...
#define AEM_CFG_STREAM_OUTPUT_NAME_3			"Stream output 3" // AAF - 48000Hz - SR CLASS B
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_3		0x020502180080C000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_3			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_3) }
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_3       { 0 }

#define AEM_CFG_STREAM_OUTPUT_NAME_4			"Stream output 4" // AAF - 48000Hz - SR CLASS C
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_4		0x0205021800840000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_4			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_4) }
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_4       { 0 }

#define AEM_CFG_STREAM_OUTPUT_NAME_5			"Stream output 5" // AAF - 48000Hz - SR CLASS E
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_5		0x0205021800830000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_5			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_5) }
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_5       { 0 }

#define AEM_CFG_STREAM_OUTPUT_NAME_6			"Stream output 6" // AAF - 96000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_6		0x020702180080C000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_6			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_6) }
#define AEM_CFG_STREAM_OUTPUT_REDUNDANT_STREAMS_6       { 0 }

#define AEM_CFG_STREAM_OUTPUT_NAME_7			"Stream output 7" // AAF - 192000Hz - SR CLASS A
...
#define AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_7		0x0209021800818000
...
#define AEM_CFG_STREAM_OUTPUT_FORMATS_7			{ htonll(AEM_CFG_STREAM_OUTPUT_CURRENT_FORMAT_7) }
...
#define AEM_CFG_CLK_SOURCE_NAME_1		"Clock source 1"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_1		7
#define AEM_CFG_CLK_SOURCE_FLAGS_1		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
...
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_1		1

#define AEM_CFG_CLK_SOURCE_NAME_2		"Clock source 2"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_2		7
#define AEM_CFG_CLK_SOURCE_FLAGS_2		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
...
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_2		2

#define AEM_CFG_CLK_SOURCE_NAME_3		"Clock source 3"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_3		7
#define AEM_CFG_CLK_SOURCE_FLAGS_3		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
...
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_3		3

#define AEM_CFG_CLK_SOURCE_NAME_4		"Clock source 4"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_4		7
#define AEM_CFG_CLK_SOURCE_FLAGS_4		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
...
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_4		4

#define AEM_CFG_CLK_SOURCE_NAME_5		"Clock source 5"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_5		7
#define AEM_CFG_CLK_SOURCE_FLAGS_5		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
#define AEM_CFG_CLK_SOURCE_TYPE_5		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_5			5
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_5		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_5		5

#define AEM_CFG_CLK_SOURCE_NAME_6		"Clock source 6"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_6		7
#define AEM_CFG_CLK_SOURCE_FLAGS_6		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
#define AEM_CFG_CLK_SOURCE_TYPE_6		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_6			6
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_6		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_6		6

#define AEM_CFG_CLK_SOURCE_NAME_7		"Clock source 7"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_7		7
#define AEM_CFG_CLK_SOURCE_FLAGS_7		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
#define AEM_CFG_CLK_SOURCE_TYPE_7		AEM_CLOCK_SOURCE_TYPE_INPUT_STREAM
#define AEM_CFG_CLK_SOURCE_ID_7			7
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_7		AEM_DESC_TYPE_STREAM_INPUT
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_7		7

#define AEM_CFG_CLK_SOURCE_NAME_8		"Clock source 8 (Internal)"
#define AEM_CFG_CLK_SOURCE_LOC_DESC_8		7
#define AEM_CFG_CLK_SOURCE_FLAGS_8		AEM_CLOCK_SOURCE_FLAGS_LOCAL_ID
#define AEM_CFG_CLK_SOURCE_TYPE_8		AEM_CLOCK_SOURCE_TYPE_INTERNAL
#define AEM_CFG_CLK_SOURCE_ID_8			8
#define AEM_CFG_CLK_SOURCE_LOC_TYPE_8		0
#define AEM_CFG_CLK_SOURCE_LOC_INDEX_8		0
...
#define AEM_CFG_CLK_SOURCE_DESCRIPTORS	{	\
						...
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(4), AEM_CFG_CLK_SOURCE_DESCRIPTOR(5), \
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(6), AEM_CFG_CLK_SOURCE_DESCRIPTOR(7), \
						AEM_CFG_CLK_SOURCE_DESCRIPTOR(8), \
					}
...
#define AEM_CFG_CLK_DOMAIN_SOURCE_IDX_0		8
#define AEM_CFG_CLK_DOMAIN_SOURCES_COUNT_0	9
#define AEM_CFG_CLK_DOMAIN_SOURCES_0		{htons(0), htons(1), htons(2), htons(3), htons(4), htons(5), htons(6), htons(7), htons(8)}
...
#endif /* _TALKER_LISTENER_AUDIO_MULTI_H_ */
