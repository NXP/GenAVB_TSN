...
int aecp_aem_send_set_name(struct avb_control_handle *ctrl_h, avb_u64 *entity_id, avb_u16 configuration_index, avb_u16 descriptor_type, avb_u16 descriptor_index, avb_u16 name_index, const char *name, avb_u8 *status, int sync);
