...
typedef struct _AAR_AVB_SET {
	...
	unsigned int stream_count;		/**< Number of connected streams of this set. */
...
typedef struct _AAR_AVB_STREAM {
	...
	aar_avb_set_t *set;			/**< Stream set associated to this elementary stream. */
...
#define MAX_AVB_TALKERS		6
#define MAX_AVB_LISTENERS	6
