...
struct avdecc_controlled {
	...
	int (*aem_get_audio_mappings_handler)(avb_u16 desc_index, avb_u16 desc_type, avb_u16 map_index, avb_u16 *number_of_maps, avb_u16 *mappings_count, void *audio_mappings);
	int (*aem_add_audio_mappings_handler)(avb_u16 desc_index, avb_u16 desc_type, avb_u16 mappings_count, void *audio_mappings);
	int (*aem_remove_audio_mappings_handler)(avb_u16 desc_index, avb_u16 desc_type, avb_u16 mappings_count, void *audio_mappings);
