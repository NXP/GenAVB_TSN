...
static void usage (void)
{
	...
	printf("\nOptions:\n"
		...
		"\t-n <entity_id> <configuration_id> <descritptor_type> <descriptor_index> <name_index> \"<name>\"	Send SET_NAME command to a descriptor\n"
...
int main(int argc, char *argv[])
{
	...
	while ((option = getopt(argc, argv,"S:G:c:d:r:t:s:lhL:T:n:")) != -1) {
		if (optind > 3) {
