...
struct acmp_ctx {
	...
	unsigned int max_listener_streams;    /* total number of listener streams in the entity's current configuration. */
	unsigned int max_talker_streams;      /* total number of talker streams in the entity's current configuration.  */
