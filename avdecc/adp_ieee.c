...
start:
	...
	case ADP_ENTITY_ADV_NOT_STARTED:
		...
		case ADP_ENTITY_ADV_EVENT_BEGIN:
			...
			timer_start(&adv->delay_timer, random_range(ADP_IEEE_ADV_TMR_DELAY_MS_MIN, genavb_max(1, (entity->valid_time / 5)) * MS_PER_S));
	...
	case ADP_ENTITY_ADV_ADVERTISE:
		...
		*/
		timer_start(&adv->reannounce_timer, genavb_max(1, (entity->valid_time / 4)) * MS_PER_S);
