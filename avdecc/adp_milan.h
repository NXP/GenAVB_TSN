...
typedef enum {
	...
	ADP_MILAN_ADV_SHUTDOWN_CONFIG_CHANGE,	/* Custom (not in the spec) event to notify a change in the AEM configuration. */
...
int adp_milan_advertise_exit(struct adp_ctx *adp, bool config_change);
