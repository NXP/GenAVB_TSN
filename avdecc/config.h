...
#define AVDECC_CFG_MAX_INFLIGHT			5
#define AVDECC_CFG_MAX_INFLIGHT_SIZE		128
#define AVDECC_CFG_INFLIGHT_TIMER_RESOLUTION	10

#define AECP_CFG_MAX_UNSOLICITED		8
...
#define ADP_CFG_NUM_ENTITIES_DISCOVERY		16
...
#define ACMP_CFG_MAX_LISTENER_STREAMS		8

#define ACMP_CFG_MAX_TALKER_STREAMS		8
#define ACMP_CFG_MAX_LISTENER_PAIRS		10
