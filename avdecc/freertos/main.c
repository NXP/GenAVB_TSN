...
__init static void process_avdecc_entity(struct avdecc_entity_config *entity_cfg)
{
	...
	if (entity_cfg->talker_entity_id_n > ACMP_CFG_MAX_UNIQUE_ID)
		entity_cfg->talker_entity_id_n = ACMP_CFG_MAX_UNIQUE_ID;


	if (entity_cfg->talker_unique_id_n > ACMP_CFG_MAX_UNIQUE_ID)
		entity_cfg->talker_unique_id_n = ACMP_CFG_MAX_UNIQUE_ID;

	if (entity_cfg->listener_unique_id_n > ACMP_CFG_MAX_UNIQUE_ID)
		entity_cfg->listener_unique_id_n = ACMP_CFG_MAX_UNIQUE_ID;

	if (entity_cfg->valid_time > CFG_ADP_MAX_VALID_TIME)
		entity_cfg->valid_time = CFG_ADP_MAX_VALID_TIME;

	if (entity_cfg->valid_time < CFG_ADP_MIN_VALID_TIME)
		entity_cfg->valid_time = CFG_ADP_MIN_VALID_TIME;
}
