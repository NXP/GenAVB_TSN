...
/* MAAP messages */
#define ipc_maap_command genavb_maap_command
#define ipc_maap_response genavb_maap_response
...
struct ipc_desc {
	...
	union {
		...
		struct ipc_maap_command maap_command;
		struct ipc_maap_response maap_response;
