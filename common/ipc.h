...
#define IPC_MEDIA_STACK_MAAP_TYPE		IPC_TYPE_SINGLE_READER_WRITER
#define IPC_MAAP_MEDIA_STACK_TYPE		IPC_TYPE_SINGLE_READER_WRITER
#define IPC_MAAP_MEDIA_STACK_SYNC_TYPE		IPC_TYPE_SINGLE_READER_WRITER
...
#define IPC_AVDECC_MSRP_TYPE			IPC_TYPE_SINGLE_READER_WRITER
