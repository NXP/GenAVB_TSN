...
*
*/
#define api_CFG_LOG		LOG_INFO

#define avdecc_CFG_LOG		LOG_INFO

#define avtp_CFG_LOG		LOG_INFO

#define common_CFG_LOG		LOG_INFO

#define gptp_CFG_LOG		LOG_INFO

#define maap_CFG_LOG		LOG_INFO

#define management_CFG_LOG	LOG_INFO

#define os_CFG_LOG			LOG_INFO

#define srp_CFG_LOG			LOG_INFO
