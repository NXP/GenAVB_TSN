...
/*
* PTP Version (802.1AS - 10.5.2.2.3)
*/
...
#define PTP_CONTROL_PDELAY_REQ		0x5
#define PTP_CONTROL_PDELAY_RESP		0x5
#define PTP_CONTROL_PDELAY_RESP_FUP	0x5
#define PTP_CONTROL_ANNOUNCE		0x5
...
typedef enum {
	CLOCK_SLAVE_SYNC_SM_EVENT_RCVD_PSSYNC = 0,
	CLOCK_SLAVE_SYNC_SM_EVENT_TICK_RECEIVED,
	CLOCK_SLAVE_SYNC_SM_EVENT_RUN
}ptp_clock_slave_sync_sm_event_t;
...
typedef enum {
	CLOCK_MASTER_SYNC_OFFSET_SM_EVENT_RCVD_SYNC_RECEIPT_TIME = 0
}ptp_clock_master_sync_offset_sm_event_t;
...
typedef enum {
	CLOCK_MASTER_SYNC_RECEIVE_SM_EVENT_RCVD_CLOCK_REQ = 0,
	CLOCK_MASTER_SYNC_RECEIVE_SM_EVENT_RCVD_LOCAL_TICK
}ptp_clock_master_sync_receive_sm_event_t;
...
typedef enum {
	PORT_ANNOUNCE_RCV_SM_EVENT_RUN = 0,
} ptp_port_announce_rcv_sm_event_t;
...
typedef enum {
	PORT_SYNC_SYNC_RCV_SM_EVENT_MDSYNC_RECEIVED = 0,
	PORT_SYNC_SYNC_RCV_SM_EVENT_RUN
} ptp_port_sync_sync_rcv_sm_event_t;
...
typedef enum {
	SITE_SYNC_SYNC_SM_EVENT_PSSYNC_RECEIVED = 0,
	SITE_SYNC_SYNC_SM_EVENT_RUN
} ptp_site_sync_sync_sm_event_t;
...
typedef enum {
	...
	PDELAY_REQ_SM_EVENT_TIMESTAMP_RECEIVED = PDELAY_REQ_SM_EVENT_MIN_VALUE,
	PDELAY_REQ_SM_EVENT_RESP_RECEIVED,
	PDELAY_REQ_SM_EVENT_FUP_RECEIVED,
	PDELAY_REQ_SM_EVENT_REQ_INTERVAL,
...
struct ptp_md_entity_pdelay_req_sm {
	...
	*/
	...
	/*
	a Boolean variable that indicates whether or not initial Pdelay_Resp
	and Pdelay_Resp_Follow_Up messages have been received when initializing the neighborRateRatio
	measurement. This variable is initialized to FALSE when the port initializes or re-initializes, and after a
	Pdelay_Resp and/or Pdelay_Resp_Follow_Up message are not received in response to a sent Pdelay_Req
	message.
	*/
	u8 initPdelayRespReceived;
...
typedef enum {
	...
	PDELAY_RESP_SM_EVENT_TIMESTAMP_RECEIVED = PDELAY_RESP_SM_EVENT_MIN_VALUE,
	PDELAY_RESP_SM_EVENT_REQ_RECEIVED,
...
typedef enum {
	...
	SYNC_RCV_SM_EVENT_SYNC_RECEIVED = SYNC_RCV_SM_EVENT_MIN_VALUE,
	SYNC_RCV_SM_EVENT_FUP_TIMEOUT,
	SYNC_RCV_SM_EVENT_FUP_RECEIVED,
