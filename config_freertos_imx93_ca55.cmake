...
set(FREERTOS_PORT GCC/AARCH64_SRE)
set(FREERTOS_APP_INCLUDES  ${FREERTOS_APPS}/common ${FREERTOS_APPS}/common/freertos ${FREERTOS_APPS}/common/libs/hlog)
set(FREERTOS_BOARD_INCLUDE ${FREERTOS_APPS}/common/freertos/boards/mcimx93evk ${AppBoardPath} ${AppPath}/common/boards/mcimx93evk ${FREERTOS_APPS}/common/boards/mcimx93evk)
set(FREERTOS_SDK_DEVICE_DIRS ${FREERTOS_SDK}/devices/MIMX9352 ${FREERTOS_SDK}/devices/MIMX9352/drivers)
set(FREERTOS_SDK_TARGET_DIRS ${FREERTOS_SDK}/CMSIS/Core_AArch64/Include ${FREERTOS_SDK}/drivers/cache/armv8-a)
set(FREERTOS_SDK_DRIVERS_DIRS ${FREERTOS_SDK}/drivers ${FREERTOS_SDK}/drivers/common ${FREERTOS_SDK}/drivers/enet_qos ${FREERTOS_SDK}/drivers/tpm)

set(INCLUDE_DIR ${FREERTOS_DIR}/include)

add_compile_definitions(GUEST CPU_MIMX9352DVUXM_ca55 ENET_ENHANCEDBUFFERDESCRIPTOR_MODE)
