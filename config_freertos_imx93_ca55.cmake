...
set(APP_GENAVB_SDK_INCLUDE ${AppPath}/common/boards/mcimx93evk)
set(MCUX_SDK_DEVICE_DIRS ${MCUX_SDK}/devices/MIMX9352 ${MCUX_SDK}/devices/MIMX9352/drivers)
set(MCUX_SDK_TARGET_DIRS ${MCUX_SDK}/CMSIS/Core_AArch64/Include ${MCUX_SDK}/drivers/cache/armv8-a)
set(MCUX_SDK_DRIVERS_DIRS ${MCUX_SDK}/drivers ${MCUX_SDK}/drivers/common ${MCUX_SDK}/drivers/enet_qos ${MCUX_SDK}/drivers/tpm)
