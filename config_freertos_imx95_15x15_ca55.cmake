...
set(APP_GENAVB_SDK_INCLUDE ${AppPath}/common/boards/imx95lp4xevk15 ${AppPath}/freertos/boards/imx95lp4xevk15)
set(MCUX_SDK_DEVICE_DIRS ${MCUX_SDK}/devices/MIMX9596 ${MCUX_SDK}/devices/MIMX9596/drivers)
set(MCUX_SDK_TARGET_DIRS ${MCUX_SDK}/CMSIS/Core_AArch64/Include ${MCUX_SDK}/drivers/cache/armv8-a)
set(MCUX_SDK_DRIVERS_DIRS
  ${MCUX_SDK}/drivers
  ${MCUX_SDK}/drivers/common
  ${MCUX_SDK}/drivers/netc
  ${MCUX_SDK}/drivers/tpm
  ${MCUX_SDK}/components/clock
  ${MCUX_SDK}/components/clock/porting/platform/imx95
  ${MCUX_SDK}/drivers/netc/socs/imx95
  ${MCUX_SDK}/drivers/msgintr
)

set(INCLUDE_DIR ${RTOS_DIR}/include)

add_compile_definitions(GUEST CPU_MIMX9596AVTXN_ca55)
