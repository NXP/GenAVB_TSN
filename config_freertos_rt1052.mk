-include local_config_freertos_rt1052.mk
...
FREERTOS_BOARD_INCLUDE?=$(FREERTOS_APPS)/boards/evkbimxrt1050/demo_apps/avb_tsn/common
FREERTOS_DEVICE?=$(FREERTOS_SDK)/devices/MIMXRT1052

INCLUDE_DIR?=$(PREFIX)/include
LIB_DIR?=$(PREFIX)/lib
DEVKIT_DIR?=$(shell pwd)/build/freertos_devkit

CFLAGS += -Os -mthumb -mcpu=cortex-m7 -mfloat-abi=hard -mfpu=fpv5-d16 -DCPU_MIMXRT1052DVL6B -DENET_ENHANCEDBUFFERDESCRIPTOR_MODE
