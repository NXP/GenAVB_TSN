...
set(FREERTOS_CONFIG_INCLUDES ${RTOS_APPS}/boards/evkbmimxrt1170/demo_apps/avb_tsn/common/cm7 ${RTOS_APPS}/boards/src/demo_apps/avb_tsn/common)
endif()
if(NOT DEFINED APP_GENAVB_SDK_INCLUDE)
set(APP_GENAVB_SDK_INCLUDE ${RTOS_APPS}/boards/evkbmimxrt1170/demo_apps/avb_tsn/common/cm7)
endif()
set(MCUX_SDK_DEVICE_DIRS ${MCUX_SDK}/devices/MIMXRT1176 ${MCUX_SDK}/devices/MIMXRT1176/drivers ${MCUX_SDK}/devices/MIMXRT1176/drivers/cm7 ${MCUX_SDK}/devices/MIMXRT1176/periph)
