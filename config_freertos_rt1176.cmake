...
set(FREERTOS_BOARD_INCLUDE ${FREERTOS_APPS}/boards/evkmimxrt1170/demo_apps/avb_tsn/common)
set(FREERTOS_SDK_DEVICE_DIRS ${FREERTOS_SDK}/devices/MIMXRT1176 ${FREERTOS_SDK}/devices/MIMXRT1176/drivers ${FREERTOS_SDK}/devices/MIMXRT1176/drivers/cm7)
set(FREERTOS_SDK_TARGET_DIRS ${FREERTOS_SDK}/CMSIS/Core/Include)

set(INCLUDE_DIR usr/include)

add_compile_definitions(CPU_MIMXRT1176DVMAA_cm7 ENET_ENHANCEDBUFFERDESCRIPTOR_MODE CFG_PHY_OLD_INTERFACE)
