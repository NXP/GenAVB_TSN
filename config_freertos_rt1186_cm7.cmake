...
set(FREERTOS_CONFIG_INCLUDES ${RTOS_APPS}/boards/frdmimxrt1186/demo_apps/avb_tsn/common/cm7 ${RTOS_APPS}/devices/MIMXRT118x/common/cm7 ${RTOS_APPS}/boards/src/demo_apps)
endif()
if(NOT DEFINED APP_GENAVB_SDK_INCLUDE)
set(APP_GENAVB_SDK_INCLUDE ${RTOS_APPS}/boards/frdmimxrt1186/demo_apps/avb_tsn/tsn_app/cm7 ${RTOS_APPS}/devices/MIMXRT118x/common/cm7)
endif()
...
add_compile_definitions(CPU_MIMXRT1186XVJ8C_cm7)
