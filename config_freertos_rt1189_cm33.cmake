...
set(FREERTOS_CONFIG_INCLUDES ${RTOS_APPS}/boards/evkmimxrt1180/demo_apps/avb_tsn/common/cm33 ${RTOS_APPS}/devices/MIMXRT118x/common/cm33 ${RTOS_APPS}/boards/src/demo_apps/avb_tsn/common)
endif()
if(NOT DEFINED APP_GENAVB_SDK_INCLUDE)
set(APP_GENAVB_SDK_INCLUDE ${RTOS_APPS}/boards/evkmimxrt1180/demo_apps/avb_tsn/common/cm33 ${RTOS_APPS}/boards/evkmimxrt1180/demo_apps/avb_tsn/tsn_app/cm33 ${RTOS_APPS}/devices/MIMXRT118x/common/cm33)
endif()
set(MCUX_SDK_DEVICE_DIRS ${MCUX_SDK}/devices/MIMXRT1189 ${MCUX_SDK}/devices/MIMXRT1189/drivers ${MCUX_SDK}/devices/MIMXRT1189/drivers/cm33 ${MCUX_SDK}/devices/MIMXRT1189/periph ${MCUX_SDK}/platform/drivers/netc/socs/imxrt1180)
