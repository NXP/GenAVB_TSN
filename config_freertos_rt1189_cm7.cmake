...
set(FREERTOS_APP_INCLUDES ${FREERTOS_APPS}/boards/src/demo_apps/avb_tsn/common/cm7 ${FREERTOS_APPS}/boards/src/demo_apps/avb_tsn/common)
set(FREERTOS_BOARD_INCLUDE ${FREERTOS_APPS}/boards/evkmimxrt1180/demo_apps/avb_tsn/common/cm7)
set(FREERTOS_DEVICE ${FREERTOS_SDK}/devices/MIMXRT1189)
set(FREERTOS_SDK_DEVICE_DIRS ${FREERTOS_SDK}/devices/MIMXRT1189 ${FREERTOS_SDK}/devices/MIMXRT1189/drivers ${FREERTOS_SDK}/devices/MIMXRT1189/drivers/cm7)
set(FREERTOS_SDK_TARGET_DIRS ${FREERTOS_SDK}/CMSIS/Core/Include)

set(INCLUDE_DIR usr/include)

add_compile_definitions(CPU_MIMXRT1189CVM8A_cm7)
