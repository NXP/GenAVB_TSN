...
set(FREERTOS_BOARD_INCLUDE ${FREERTOS_APPS}/common/freertos/boards/evkmimx8mn ${AppBoardPath} ${AppPath}/common/boards/evkmimx8mn ${FREERTOS_APPS}/common/boards/evkmimx8mn)
...
set(FREERTOS_SDK_DRIVERS_DIRS ${FREERTOS_SDK}/drivers ${FREERTOS_SDK}/drivers/common ${FREERTOS_SDK}/drivers/enet ${FREERTOS_SDK}/drivers/gpt)
