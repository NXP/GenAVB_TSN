...
static int __clock_time_to_cycles(os_clock_id_t clk_id, uint64_t ns, uint64_t *cycles)
{
	struct os_clock *c;
...
int clock_time_to_cycles_isr(os_clock_id_t clk_id, uint64_t ns, uint64_t *cycles)
{
