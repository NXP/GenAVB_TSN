...
static struct hw_avb_timer gtimer;
...
__init void hw_avb_timer_start(void)
{
...
__exit static void __hw_avb_timer_stop(struct hw_avb_timer *timer)
{
	if (timer->users) {
		timer->users--;
...
__exit void hw_avb_timer_stop(void)
{
	struct hw_avb_timer *timer;
	...
	__hw_avb_timer_stop(timer);
}

__init int hw_avb_timer_register_device(struct hw_avb_timer_dev *dev)
{
	int rc = 0;
	struct hw_avb_timer *timer;
...
__exit void hw_avb_timer_unregister_device(struct hw_avb_timer_dev *dev)
{
	struct hw_avb_timer *timer;
