...
/**
 @file msgintr.h
 @brief FreeRTOS specific Message Interrupt block implementation
 @details
*/

#ifndef _FREERTOS_NET_PORT_MSGINTR_H_
#define _FREERTOS_NET_PORT_MSGINTR_H_
...
#endif /* _FREERTOS_NET_PORT_MSGINTR_H_ */
