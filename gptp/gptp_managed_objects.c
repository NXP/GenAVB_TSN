...
__init void gptp_managed_objects_init(struct gptp_managed_objects *module, struct gptp_ctx *gptp)
{
	...
	LEAF_INIT(&module->port_parameter_data_set.port[0], allowedFaults, LEAF_UINT16, LEAF_RW, (void *)offset_of(struct gptp_port_common, md.globals.allowedFaults), ptp_port_common_handler, NULL);
