...
#define ADP_ENTITY_ACMP_ACQUIRE_WITH_AEM		(1 << 18)
#define ADP_ENTITY_ACMP_AUTHENTICATE_WITH_AEM		(1 << 19)
#define ADP_ENTITY_SUPPORTS_UDPV4_ATDECC		(1 << 20)
#define ADP_ENTITY_SUPPORTS_UDPV4_STREAMING		(1 << 21)
#define ADP_ENTITY_SUPPORTS_UDPV6_ATDECC		(1 << 22)
#define ADP_ENTITY_SUPPORTS_UDPV6_STREAMING		(1 << 23)
#define ADP_ENTITY_MULTIPLE_PTP_INSTANCES		(1 << 24)
#define ADP_ENTITY_AEM_CONFIGURATION_INDEX_VALID	(1 << 25)
...
#define ADP_CONTROLLER_LOCALLY_VISIBLE	(1 << 31)	/**< Custom flag used by a controller to be only locally visible, thus not discovered/appearing on the network. */
