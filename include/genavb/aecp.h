 ...
 * Copyright 2016-2017, 2019, 2021-2026 NXP
 *
...
/**
 * \ingroup aem
 * From section 9.4.2 of IEEE 1722.1-2021.
 */
struct __attribute__ ((packed)) aecp_addr_access_pdu {
	avb_u64 entity_id;			/**< See ::aecp_pdu. */
	avb_u64 controller_entity_id;		/**< See ::aecp_pdu. */
	avb_u16 sequence_id;			/**< See ::aecp_pdu. */
	avb_u16 tlv_count;			/**< Number of TLVs in the data. */
};

/**
 * \ingroup aem
 * From section 9.4, Figure 9-6 of IEEE 1722.1-2021.
 */
struct __attribute__ ((packed)) aecp_addr_access_tlv {
	...
	avb_u64 address;
	/* Variable length memory_data */
};

#ifdef __BIG_ENDIAN__
#define AECP_ADDR_ACCESS_GET_LENGTH(tlv)	((tlv)->length)
#define AECP_ADDR_ACCESS_SET_LENGTH(tlv, val)	((tlv)->length = (val))
#else
#define AECP_ADDR_ACCESS_GET_LENGTH(tlv)	(((tlv)->length_msb << 8) | (tlv)->length_lsb)
#define AECP_ADDR_ACCESS_SET_LENGTH(tlv, val)	do {(tlv)->length_msb = (val) >> 8; (tlv)->length_lsb = (val) & 0xff; } while(0)
#endif

#define AECP_ADDR_ACCESS_MODE_READ	0
#define AECP_ADDR_ACCESS_MODE_WRITE	1
#define AECP_ADDR_ACCESS_MODE_EXECUTE	2
 ...
 */
#define aecp_aem_get_configuration_pdu	aecp_aem_set_configuration_pdu
...
#define AECP_AEM_AVB_INFO_AS_CAPABLE		(1 << 0) /**< The IEEE Std 802.1AS-2011 variable asCapable is set on this interface. */
#define AECP_AEM_AVB_INFO_GPTP_ENABLED		(1 << 1) /**< Indicates that the interface has the IEEE Std 802.1AS-2011 functionality enabled. */
#define AECP_AEM_AVB_INFO_SRP_ENABLED		(1 << 2) /**< Indicates that the interface has the IEEE Std 802.1Q-2011 Clause 35, “Stream Reservation Protocol (SRP)” functionality enabled.*/
...
/**
 * \ingroup aem
 * From section 5.4.4.1 of Milan v1.2
 */
 ...
 * From section 5.4.4.1 of Milan v1.2
 */
#define AECP_MILAN_INFO_FEATURES_FLAG_REDUNDANCY	(1 << 0) /**< Redundancy is supported on this entity in its current configuration. */
...
/**
 * \ingroup aem
 * From section 5.4.4.2 of Milan v1.2
 */
struct __attribute__ ((packed)) aecp_mvu_set_system_unique_id_cmd_pdu {
	avb_u16 reserved;
	avb_u32 system_unique_id;	/**< System-wide unique id of the PAAD. Default value is 0. */
};
 ...
 * From section 5.4.4.2 of Milan v1.2
 */
#define aecp_mvu_set_system_unique_id_rsp_pdu	aecp_mvu_set_system_unique_id_cmd_pdu

/**
 * \ingroup aem
 * From section 5.4.4.3 of Milan v1.2
 */
#define aecp_mvu_get_system_unique_id_cmd_pdu	aecp_mvu_get_milan_info_cmd_pdu

/**
 * \ingroup aem
 * From section 5.4.4.3 of Milan v1.2
 */
#define aecp_mvu_get_system_unique_id_rsp_pdu	aecp_mvu_set_system_unique_id_cmd_pdu

/**
 * \ingroup aem
 * From section 5.4.4.4 of Milan v1.2
 */
#define AECP_AEM_MEDIA_CLOCK_REFERENCE_PRIORITY_VALID		(1 << 0) /**< The value in the user_media_clock_reference_priority field is valid. */
#define AECP_AEM_MEDIA_CLOCK_DOMAIN_NAME_VALID			(1 << 1) /**< The value in the media_clock_domain_name field is valid. */

struct __attribute__ ((packed)) aecp_mvu_set_media_clock_ref_info_cmd_pdu {
	avb_u16 clock_domain_index;		/**< Index of the concerned clock domain descriptor. */
	avb_u8 flags;				/**< Flags for the validity of the user_media_clock_reference_priority field. */
	avb_u8 reserved_1;
	avb_u8 default_mcr_prio;		/**< Default media clock reference priority of the PAAD for the clock domain. */
	avb_u8 user_mcr_prio;			/**< User defined media clock reference priority of the PAAD for the clock domain. By default, equals to default_mcr_prio. */
	avb_u32 reserved_2;
	avb_u8 media_clock_domain_name[AEM_STR_LEN_MAX];	/**< Media clock domain name for the clock domain. By default, equals "DEFAULT". */
};
 ...
 * From section 5.4.4.4 of Milan v1.2
 */
#define aecp_mvu_set_media_clock_ref_info_rsp_pdu	aecp_mvu_set_media_clock_ref_info_cmd_pdu

/**
 * \ingroup aem
 * From section 5.4.4.5 of Milan v1.2
 */
struct __attribute__ ((packed)) aecp_mvu_get_media_clock_ref_info_cmd_pdu {
	avb_u16 clock_domain_index;		/**< Index of the concerned clock domain descriptor. */
};
 ...
 * From section 5.4.4.5 of Milan v1.2
 */
#define aecp_mvu_get_media_clock_ref_info_rsp_pdu	aecp_mvu_set_media_clock_ref_info_cmd_pdu
...
/**
 * \ingroup aem
 * From section 7.4.39 of IEEE 1722.1-2021.
 */
#define aecp_aem_identify_notification_pdu	aecp_aem_set_get_control_pdu
...
/**
 * \ingroup aem
 * From section 7.4.42 of IEEE 1722.1-2021.
 */
...
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_8		24
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_7		25
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_6		26
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_5		27
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_4		28
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_3		29
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_2		30
#define AECP_AEM_COUNTER_CLOCK_DOMAIN_ENTITY_SPECIFIC_1		31
...
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_8	24
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_7	25
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_6	26
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_5	27
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_4	28
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_3	29
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_2	30
#define AECP_AEM_COUNTER_STREAM_OUTPUT_ENTITY_SPECIFIC_1	31

#define AECP_AEM_MILAN_COUNTER_STREAM_OUTPUT_MEDIA_RESET		2
#define AECP_AEM_MILAN_COUNTER_STREAM_OUTPUT_TIMESTAMP_UNCERTAIN	3
#define AECP_AEM_MILAN_COUNTER_STREAM_OUTPUT_FRAMES_TX			4

#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_STREAM_INTERRUPTED		2
#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_MEDIA_RESET			3
#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_TIMESTAMP_UNCERTAIN		4
#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_TIMESTAMP_VALID		5
#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_TIMESTAMP_NOT_VALID		6
#define AECP_AEM_IEEE_COUNTER_STREAM_OUTPUT_FRAMES_TX			7

#define AECP_AEM_COUNTER_PTP_PORT_RX_SYNC			0
#define AECP_AEM_COUNTER_PTP_PORT_RX_ONE_STEP_SYNC		1
#define AECP_AEM_COUNTER_PTP_PORT_RX_FOLLOWUP			2
#define AECP_AEM_COUNTER_PTP_PORT_RX_PDELAY_REQUEST		3
#define AECP_AEM_COUNTER_PTP_PORT_RX_PDELAY_RESPONSE		4
#define AECP_AEM_COUNTER_PTP_PORT_RX_PDELAY_RESPONSE_FOLLOWUP	5
#define AECP_AEM_COUNTER_PTP_PORT_RX_ANNOUNCE			6
#define AECP_AEM_COUNTER_PTP_PORT_RX_SIGNAL			7
#define AECP_AEM_COUNTER_PTP_PORT_RX_PACKET_DISCARD		8
#define AECP_AEM_COUNTER_PTP_PORT_RX_DELAY_REQUEST		9
#define AECP_AEM_COUNTER_PTP_PORT_RX_DELAY_RESPONSE		10
#define AECP_AEM_COUNTER_PTP_PORT_SYNC_RECEIPT_TIMEOUT		11
#define AECP_AEM_COUNTER_PTP_PORT_PDELAY_ALLOWED_EXCEEDED	12
#define AECP_AEM_COUNTER_PTP_PORT_TX_SYNC			13
#define AECP_AEM_COUNTER_PTP_PORT_TX_ONE_STEP_SYNC		14
#define AECP_AEM_COUNTER_PTP_PORT_TX_FOLLOWUP			15
#define AECP_AEM_COUNTER_PTP_PORT_TX_PDELAY_REQUEST		16
#define AECP_AEM_COUNTER_PTP_PORT_TX_PDELAY_RESPONSE		17
#define AECP_AEM_COUNTER_PTP_PORT_TX_PDELAY_RESPONSE_FOLLOWUP	18
#define AECP_AEM_COUNTER_PTP_PORT_TX_ANNOUNCE			19
#define AECP_AEM_COUNTER_PTP_PORT_TX_SIGNAL			20
#define AECP_AEM_COUNTER_PTP_PORT_TX_PACKET_DISCARD		21
#define AECP_AEM_COUNTER_PTP_PORT_TX_DELAY_REQUEST		22
#define AECP_AEM_COUNTER_PTP_PORT_TX_DELAY_RESPONSE		23
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_8		24
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_7		25
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_6		26
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_5		27
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_4		28
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_3		29
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_2		30
#define AECP_AEM_COUNTER_PTP_PORT_ENTITY_SPECIFIC_1		31
...
/**
 * \ingroup aem
 * From section 7.4.45 of IEEE 1722.1-2013.
 */
struct __attribute__ ((packed)) aecp_aem_add_audio_mappings_cmd_pdu {
	avb_u16 descriptor_type;	/**< Type of the descriptor to be read. */
	avb_u16 descriptor_index;	/**< Index of the descriptor to be read. */
	avb_u16 number_of_mappings;
	avb_u16 reserved;
...
/**
 * \ingroup aem
 * From section 7.4.46 of IEEE 1722.1-2013.
 */
#define aecp_aem_remove_audio_mappings_cmd_pdu aecp_aem_add_audio_mappings_cmd_pdu
#define aecp_aem_modify_audio_mappings_cmd_pdu aecp_aem_add_audio_mappings_cmd_pdu

/**
 * \ingroup aem
 * From section 7.4.76 of IEEE 1722.1-2021.
 */
struct __attribute__ ((packed)) aecp_aem_dynamic_info_format {
	avb_u16 info_command_specific_data_length;
	avb_u16 reserved_1;
	avb_u8 info_status;
	avb_u8 reserved_2;
	avb_u16 info_command_type;
	/* variable size (info_command_specific_data_length) data info_command_specific_data */
};
...
typedef enum {
	...
	AECP_ADDRESS_ACCESS_COMMAND	= 0x02,		/**< AECP message type, ADDRESS_ACCESS command. */
	AECP_ADDRESS_ACCESS_RESPONSE	= 0x03,		/**< AECP message type, ADDRESS_ACCESS response. */
...
typedef enum {
	...
	AECP_AEM_CMD_GET_DYNAMIC_INFO			= 0x004b,
	AECP_AEM_CMD_EXPANSION				= 0x7fff
} aecp_aem_command_type_t;

/**
 * \ingroup aem
 * AECP MVU commands, from table 5.18 of Milan v1.2
 */
typedef enum {
	AECP_MVU_CMD_GET_MILAN_INFO			= 0x0000,
	AECP_MVU_CMD_SET_SYSTEM_UNIQUE_ID		= 0x0001,
	AECP_MVU_CMD_GET_SYSTEM_UNIQUE_ID		= 0x0002,
	AECP_MVU_CMD_SET_MEDIA_CLOCK_REFERENCE_INFO	= 0x0003,
	AECP_MVU_CMD_GET_MEDIA_CLOCK_REFERENCE_INFO	= 0x0004,
...
typedef enum {
	...
	AECP_AEM_TIMEOUT		= 13 /**< Added for communication with GenAVB/TSN controller application, to signal a timeout waiting for a response from the target entity */
} aecp_status_t;

/**
 * \ingroup aem
 * AECP Address Access status codes, from section 9.4.2.4 and table 9-4 of IEEE 1722.1-2021.
 */
typedef enum {
	AECP_ADDRESS_ACCESS_SUCCESS		= 0,  /**< The AVDECC Entity successfully performed the command and has valid results. */
	AECP_ADDRESS_ACCESS_NOT_IMPLEMENTED	= 1,  /**< The AVDECC Entity does not support the command type. */
	AECP_ADDRESS_ACCESS_ADDRESS_TOO_LOW	= 2,  /**< The value in the address field is below the start of the memory map. */
	AECP_ADDRESS_ACCESS_ADDRESS_TOO_HIGH	= 3,  /**< The value in the address field is above to end of the memory map. */
	AECP_ADDRESS_ACCESS_ADDRESS_INVALID	= 4,  /**< The value in the address field is within the memory map but is part of an invalid region. */
	AECP_ADDRESS_ACCESS_TLV_INVALID		= 5,  /**< One or more of the TLVs were invalid. No TLVs have been processed. */
	AECP_ADDRESS_ACCESS_DATA_INVALID	= 6,  /**< The data for writing is invalid. */
	AECP_ADDRESS_ACCESS_UNSUPPORTED		= 7,  /**< A requested action was unsupported. Typically used when an unknown EXECUTE was encountered or if EXECUTE is not supported. */
	AECP_ADDRESS_ACCESS_TIMEOUT		= 8,  /**< Custom status. The app handling the actual memory accesses failed to respond in time. */
	AECP_ADDRESS_ACCESS_MISBEHAVING		= 9,  /**< Custom status. The AVDECC Entity is generated an internal error while trying to process the command. */
	AECP_ADDRESS_ACCESS_IN_PROGRESS		= 10, /**< Custom status used only internally: The command is sent to upper layers for processing. */
} aecp_address_access_status_t;
