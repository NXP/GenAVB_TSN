 ...
 * Copyright 2016, 2018-2019, 2022-2026 NXP
 *
...
#define AEM_NUM_CLOCK_SOURCES_MAX		16
#define AEM_NUM_AUDIO_MAPS_MAX			16
#define AEM_NUM_CONTROLS_MAX			16
...
#define AEM_NUM_AVB_INTERFACES_MAX		2 /* Custom value aligned with CFG_MAX_ENDPOINTS */
/* Spec maximum 404 */
#define AEM_NUM_VALUE_DETAILS_LINEAR_U8_MAX	1
#define AEM_NUM_VALUE_DETAILS_LINEAR_UTF8_MAX	1
#define AEM_NUM_MEMORY_OBJECTS_MAX		64 /* Custom value: should not exceed AEM_MEMORY_OBJECT_DESC_IDX_MASK */
...
/* Memory object types - table 7.19 */
#define AEM_MEMORY_OBJECT_FIRMWARE_IMAGE	0x00
#define AEM_MEMORY_OBJECT_VENDOR_SPECIFIC	0x01
#define AEM_MEMORY_OBJECT_CRASH_DUMP		0x02
#define AEM_MEMORY_OBJECT_LOG_OBJECT		0x03
#define AEM_MEMORY_OBJECT_AUTOSTART_SETTINGS	0x04
#define AEM_MEMORY_OBJECT_SNAPSHOT_SETTINGS	0x05
#define AEM_MEMORY_OBJECT_SVG_MANUFACTURER	0x06
#define AEM_MEMORY_OBJECT_SVG_ENTITY		0x07
#define AEM_MEMORY_OBJECT_SVG_GENERIC		0x08
#define AEM_MEMORY_OBJECT_PNG_MANUFACTURER	0x09
#define AEM_MEMORY_OBJECT_PNG_ENTITY		0x0a
#define AEM_MEMORY_OBJECT_PNG_GENERIC		0x0b
#define AEM_MEMORY_OBJECT_DAE_MANUFACTURER	0x0c
#define AEM_MEMORY_OBJECT_DAE_ENTITY		0x0d
#define AEM_MEMORY_OBJECT_DAE_GENERIC		0x0e
#define AEM_MEMORY_OBJECT_TYPE_MAX		(AEM_MEMORY_OBJECT_DAE_GENERIC + 1)

#define AEM_MEMORY_OBJECT_CFG_IDX_SHIFT		60
#define AEM_MEMORY_OBJECT_CFG_IDX_MASK		0x0fULL
#define AEM_MEMORY_OBJECT_ADDR_CFG_IDX_MASK	(AEM_MEMORY_OBJECT_CFG_IDX_MASK << AEM_MEMORY_OBJECT_CFG_IDX_SHIFT)
#define AEM_MEMORY_OBJECT_ADDR_TO_CFG_IDX(addr) ((addr & AEM_MEMORY_OBJECT_ADDR_CFG_IDX_MASK) >> AEM_MEMORY_OBJECT_CFG_IDX_SHIFT)

#define AEM_MEMORY_OBJECT_DESC_IDX_SHIFT	52
#define AEM_MEMORY_OBJECT_DESC_IDX_MASK		0xffULL
#define AEM_MEMORY_OBJECT_ADDR_DESC_IDX_MASK	(AEM_MEMORY_OBJECT_DESC_IDX_MASK << AEM_MEMORY_OBJECT_DESC_IDX_SHIFT)
#define AEM_MEMORY_OBJECT_ADDR_TO_DESC_IDX(addr) ((addr & AEM_MEMORY_OBJECT_ADDR_DESC_IDX_MASK) >> AEM_MEMORY_OBJECT_DESC_IDX_SHIFT)

#define AEM_MEMORY_OBJECT_TYPE_SHIFT		48
#define AEM_MEMORY_OBJECT_TYPE_MASK		0x0fULL
#define AEM_MEMORY_OBJECT_ADDR_TYPE_MASK	(AEM_MEMORY_OBJECT_TYPE_MASK << AEM_MEMORY_OBJECT_TYPE_SHIFT)
#define AEM_MEMORY_OBJECT_ADDR_TO_TYPE(addr) ((addr & AEM_MEMORY_OBJECT_ADDR_TYPE_MASK) >> AEM_MEMORY_OBJECT_TYPE_SHIFT)

#define AEM_MEMORY_OBJECT_START_ADDR_MASK	0x0000ffffffffffff
#define AEM_MEMORY_OBJECT_START_ADDR(addr) (addr & AEM_MEMORY_OBJECT_START_ADDR_MASK)

#define AEM_MEMORY_OBJECT_BASE_ADDR(cfg_idx, desc_idx, type) \
	(((u64)(cfg_idx & AEM_MEMORY_OBJECT_CFG_IDX_MASK) << AEM_MEMORY_OBJECT_CFG_IDX_SHIFT) | \
	((u64)(desc_idx & AEM_MEMORY_OBJECT_DESC_IDX_MASK) << AEM_MEMORY_OBJECT_DESC_IDX_SHIFT) | \
	((u64)(type & AEM_MEMORY_OBJECT_TYPE_MASK) << AEM_MEMORY_OBJECT_TYPE_SHIFT))
...
/* Common part of all AEM descriptors. */
struct __attribute__ ((packed)) aem_descriptor_common {
...
struct __attribute__ ((packed)) entity_descriptor {
	...
	avb_u8 entity_name[AEM_STR_LEN_MAX];
	avb_u16 vendor_name_string;
	avb_u16 model_name_string;
	avb_u8 firmware_version[AEM_STR_LEN_MAX];
	avb_u8 group_name[AEM_STR_LEN_MAX];
	avb_u8 serial_number[AEM_STR_LEN_MAX];
...
struct __attribute__ ((packed)) configuration_descriptor {
	avb_u16 descriptor_type;
	avb_u16 descriptor_index;
	avb_u8 object_name[AEM_STR_LEN_MAX];
...
struct __attribute__ ((packed)) locale_descriptor {
	avb_u16 descriptor_type;
	avb_u16 descriptor_index;
	avb_u8 locale_identifier[AEM_STR_LEN_MAX];
...
struct __attribute__ ((packed)) strings_descriptor {
	avb_u16 descriptor_type;
	avb_u16 descriptor_index;
	avb_u8 strings_0[AEM_STR_LEN_MAX];
	avb_u8 strings_1[AEM_STR_LEN_MAX];
	avb_u8 strings_2[AEM_STR_LEN_MAX];
	avb_u8 strings_3[AEM_STR_LEN_MAX];
	avb_u8 strings_4[AEM_STR_LEN_MAX];
	avb_u8 strings_5[AEM_STR_LEN_MAX];
	avb_u8 strings_6[AEM_STR_LEN_MAX];
};
...
/* Memory object Table 7.18 */
struct __attribute__ ((packed)) memory_object_descriptor {
	avb_u16 descriptor_type;
	avb_u16 descriptor_index;
	avb_u8 object_name[AEM_STR_LEN_MAX];
	avb_u16 localized_description;
	avb_u16 memory_object_type;
	avb_u16 target_descriptor_type;
	avb_u16 target_descriptor_index;
	avb_u64 start_address;
	avb_u64 maximum_length;
	avb_u64 length;
	avb_u64 maximum_segment_length;
};
