...
#ifndef AEM_CFG_MEMORY_OBJECT_DESCRIPTORS
#define AEM_CFG_MEMORY_OBJECT_DESCRIPTORS {}
#endif
...
#define AEM_CFG_MEMORY_OBJECT_DESCRIPTOR(idx)	{\
							.descriptor_type = htons(AEM_DESC_TYPE_MEMORY_OBJECT),\
							.descriptor_index = htons(idx),\
							.object_name = AEM_CFG_MEMORY_OBJECT_NAME_##idx,\
							.localized_description = htons(AEM_CFG_MEMORY_OBJECT_LOC_DESC_##idx),\
							.memory_object_type = htons(AEM_CFG_MEMORY_OBJECT_TYPE_##idx),\
							.target_descriptor_type = htons(AEM_CFG_MEMORY_OBJECT_TARGET_DESC_TYPE_##idx),\
							.target_descriptor_index = htons(AEM_CFG_MEMORY_OBJECT_TARGET_DESC_INDEX_##idx),\
...
#define AEM_ENTITY_STORAGE()	\
	...
	static struct memory_object_descriptor memory_object_storage[] = AEM_CFG_MEMORY_OBJECT_DESCRIPTORS
...
#define AEM_ENTITY_INIT(aem_desc_hdr)	\
	...
	AEM_DESC_HDR_INIT(aem_desc_hdr, memory_object, AEM_DESC_TYPE_MEMORY_OBJECT)
