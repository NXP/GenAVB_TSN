 ...
 * ::GENAVB_CLOCK_AVTP_0 and ::GENAVB_CLOCK_AVTP_1 are clocks used for avtp timestamps and user should use ::genavb_stream_avtp_clock to get the right clock for a given stream.
 *
...
typedef enum {
	...
	GENAVB_CLOCK_AVTP_0,		/**< AVTP clock 0 */
	GENAVB_CLOCK_AVTP_1,		/**< AVTP clock 1 */
	GENAVB_CLOCK_MAX
} genavb_clock_id_t;
