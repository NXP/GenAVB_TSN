...
#define CFG_MAX_AEM_CONFIGS			2 /* Maximum supported configurations in AEM entities. */

#define CFG_AVTP_REDUNDANT_STREAMS_MAX	2 /* Number of redundant streams per set supported in AVTP layer (Must always be <= AEM_NUM_REDUNDANT_STREAMS_MAX) */
