...
/**
 ...
 \copyright Copyright 2018, 2020-2024 NXP
*/
...
typedef enum {
	...
	GENAVB_MSG_MEDIA_STACK_BIND,		/**< Stream bind message (From GenAVB/TSN stack to media stack/application and vice versa). Valid in ::GENAVB_CTRL_AVDECC_MEDIA_STACK channel. */
	...
	GENAVB_MSG_MEDIA_STACK_PERSISTENT_PARAM,/**< Persistent data from descriptors message (from GenAVB/TSN stack to media stack/application and vice-versa). Valid in ::GENAVB_CTRL_AVDECC_MEDIA_STACK channel. */
