...
/** GenAVB/TSN Error type
 * \ingroup error
 *
 */
#define GENAVB_ERR_TYPE(err)	((err) >> 10)

/** GenAVB/TSN Error number (for a given type)
 * \ingroup error
 *
 */
#define GENAVB_ERR_NUM(err)	((err) & 0x3ff)

/** GenAVB/TSN Error codes
 * \ingroup error
 *
 */
typedef enum {
	...
	GENAVB_ERR_STREAM_SET_ID =		GENAVB_ERR(STREAM, 8),	/**< Stream invalid set_id configuration or allocation */
	...
	GENAVB_ERR_STACK_NOT_READY = 		GENAVB_ERR(CTRL, 10),	/**< GenAVB/TSN stack not ready or not started. */
	...
	GENAVB_ERR_SOCKET_RX_SET_OPT = 		GENAVB_ERR(SOCKET, 8),	/**< Socket receive set option error */
...
/** \cond RTOS */
	...
	GENAVB_ERR_ST_NOT_SUPPORTED = 		GENAVB_ERR(ST, 0),	/**< Scheduled Traffic not supported */
	GENAVB_ERR_ST = 			GENAVB_ERR(ST, 1),	/**< Scheduled Traffic config error */
	GENAVB_ERR_ST_HW_CONFIG = 		GENAVB_ERR(ST, 2),	/**< Scheduled Traffic hardware config error */
	GENAVB_ERR_ST_MAX_SDU_NOT_SUPPORTED = 	GENAVB_ERR(ST, 3),	/**< Scheduled Traffic max SDU not supported */
	GENAVB_ERR_ST_INVALID_GCL_SIZE = 	GENAVB_ERR(ST, 4),	/**< Scheduled Traffic invalid Gate Control List size */
	GENAVB_ERR_ST_INVALID_CYCLE_PARAMS =		GENAVB_ERR(ST, 6),	/**< Scheduled Traffic invalid cycle parameters */
	GENAVB_ERR_ST_INVALID_CYCLE_TIME =		GENAVB_ERR(ST, 7),	/**< Scheduled Traffic invalid cycle time */
	GENAVB_ERR_ST_INVALID_BASETIME =		GENAVB_ERR(ST, 8),	/**< Scheduled Traffic invalid base time */
	GENAVB_ERR_ST_INVALID_GATE_OPERATION = 	GENAVB_ERR(ST, 9),	/**< Scheduled Traffic invalid gate operation */
	GENAVB_ERR_ST_ENET_QOS_CONFIG = 	GENAVB_ERR(ST, 10),	/**< Scheduled Traffic invalid ENET_QOS configuration */
	GENAVB_ERR_ST_MALLOC = 	GENAVB_ERR(ST, 11),	/**< Scheduled Traffic memory allocation error */
	GENAVB_ERR_ST_HW_READ = 	GENAVB_ERR(ST, 12),	/**< Scheduled Traffic hardware read error */
	GENAVB_ERR_ST_CONFIG_TYPE_NOT_SUPPORTED = 	GENAVB_ERR(ST, 13),	/**< Scheduled Traffic configuration type not supported */
	GENAVB_ERR_ST_GETTIME =					GENAVB_ERR(SG, 14),	/**< Scheduled Traffic gettime error */
	...
	GENAVB_ERR_SG_RESET_IRX_OEX =			GENAVB_ERR(SG, 19),	/**< Stream Gate reset IRX OEX error */
	GENAVB_ERR_SG_INVALID_GCL_SIZE =		GENAVB_ERR(SG, 20),	/**< Stream Gate invalid Gate Control List size */
	...
	GENAVB_ERR_FM_RESET_MR = 		GENAVB_ERR(FM, 6),	/**< Stream Flow Meter reset mark red error */

	GENAVB_ERR_FP_NOT_SUPPORTED =		GENAVB_ERR(FP, 0),	/**< Frame Preemption not supported */
	GENAVB_ERR_FP = 			GENAVB_ERR(FP, 1),	/**< Frame Preemption config error */
	GENAVB_ERR_FP_HW_CONFIG =		GENAVB_ERR(FP, 2),	/**< Frame Preemption hardware config error */
	GENAVB_ERR_FP_INVALID_FRAG_SIZE =		GENAVB_ERR(FP, 3),	/**< Frame Preemption invalid fragment size */
	GENAVB_ERR_FP_INVALID_VERIFY_TIME =		GENAVB_ERR(FP, 4),	/**< Frame Preemption invalid verify time */
	GENAVB_ERR_FP_INVALID_ENET_QOS_CONFIG =		GENAVB_ERR(FP, 5),	/**< Frame Preemption invalid ENET_QOS configuration */

	GENAVB_ERR_VLAN_VID = 			GENAVB_ERR(VLAN, 0),	/**< Invalid vid */
	GENAVB_ERR_VLAN_CONTROL = 		GENAVB_ERR(VLAN, 1),	/**< Invalid VLAN control field */
	GENAVB_ERR_VLAN_ENTRY_NOT_FOUND = 	GENAVB_ERR(VLAN, 2),	/**< VLAN entry not found */
	...
	GENAVB_ERR_FRER_SEQG_RESET = 		GENAVB_ERR(FRER, 8),	/**< FRER reset sequence generation error */
	...
	GENAVB_ERR_SI_NOT_SUPPORTED = 		GENAVB_ERR(SI, 0),	/**< Stream Identification not supported */
	GENAVB_ERR_SI_ADD = 		GENAVB_ERR(SI, 1),	/**< Stream Identification add error */
	GENAVB_ERR_SI_HW_CONFIG = 		GENAVB_ERR(SI, 2),	/**< Stream Identification hardware config error */
	GENAVB_ERR_SI_UPDATE = GENAVB_ERR(SI, 3),	/**< Stream Identification update error */
	GENAVB_ERR_SI_DELETE = 		GENAVB_ERR(SI, 4),	/**< Stream Identification delete error */
	GENAVB_ERR_SI_READ = 		GENAVB_ERR(SI, 5),	/**< Stream Identification read error */
	GENAVB_ERR_SI_MAX_ENTRIES = 		GENAVB_ERR(SI, 6),	/**< Stream Identification invalid entry id */
	GENAVB_ERR_SI_MAX_HANDLE = 		GENAVB_ERR(SI, 7),	/**< Stream Identification invalid handle */
	GENAVB_ERR_SI_TYPE_UPDATE_NOT_SUPPORTED = 		GENAVB_ERR(SI, 8),	/**< Stream Identification type update not supported */
	GENAVB_ERR_SI_VLAN_TYPE_UPDATE_NOT_SUPPORTED = 		GENAVB_ERR(SI, 9),	/**< Stream Identification vlan type update not supported */
	GENAVB_ERR_SI_HANDLE_UPDATE_NOT_SUPPORTED = 		GENAVB_ERR(SI, 10),	/**< Stream Identification handle update not supported */
	GENAVB_ERR_SI_ENTRY_NOT_FOUND = 		GENAVB_ERR(SI, 11),	/**< Stream Identification entry not found */
	GENAVB_ERR_SI_INVALID_STREAM_IDENTITY = 		GENAVB_ERR(SI, 12),	/**< Stream Identification invalid stream indentity */

	GENAVB_ERR_HSR_NOT_SUPPORTED =		GENAVB_ERR(HSR, 0),	/**< High-availability Seamless Redundancy not supported */

	GENAVB_ERR_FDB_NOT_SUPPORTED =		GENAVB_ERR(FDB, 0),	/**< Forwarding Data Base not supported */
	GENAVB_ERR_FDB_ENTRY_NOT_FOUND =	GENAVB_ERR(FDB, 1),	/**< Forwarding Data Base entry not found */
	GENAVB_ERR_FDB_HW_CONFIG =			GENAVB_ERR(FDB, 2),	/**< Forwarding Data Base hardware config error */
	GENAVB_ERR_FDB_INVALID_VID =		GENAVB_ERR(FDB, 3),	/**< Forwarding Data Base invalid vid */
	GENAVB_ERR_FDB_INVALID_PORT =		GENAVB_ERR(FDB, 4),	/**< Forwarding Data Base invalid logical port */
 ...
 * \ingroup error
 * \return	error string
 * \param 	error error code returned by GenAVB/TSN library functions
 */
