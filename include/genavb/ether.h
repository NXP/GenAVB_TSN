...
#define MC_ADDR_MULTICAST_IDENTIFY	{0x91, 0xe0, 0xf0, 0x01, 0x00, 0x01}	/* Multicast MAC address for Identification notification from IEEE 1722-2021, Annexe B, Table B.1 */
