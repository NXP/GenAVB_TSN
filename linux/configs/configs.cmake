...
function(system_cfg_install)
  if(EXISTS ${TARGET}_${CONFIG}_system.cfg)
    install(FILES ${CMAKE_CURRENT_LIST_DIR}/${TARGET}_${CONFIG}_system.cfg DESTINATION ${CONFIG_DIR} PERMISSIONS OWNER_WRITE OWNER_READ GROUP_WRITE GROUP_READ RENAME system.cfg)
  endif()
endfunction()

function(srp_cfg_install name)
  if(EXISTS ${TARGET}_${CONFIG}_srp${name}.cfg)
    install(FILES ${CMAKE_CURRENT_LIST_DIR}/${TARGET}_${CONFIG}_srp${name}.cfg DESTINATION ${CONFIG_DIR} PERMISSIONS OWNER_WRITE OWNER_READ GROUP_WRITE GROUP_READ RENAME srp${name}.cfg)
  else()
