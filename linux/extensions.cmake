...
function(genavb_install)
  ...
  set(os_headers "${CMAKE_CURRENT_SOURCE_DIR}/include/${TARGET_OS}/_os/*.h")

  # prepare include dir for applications
  add_custom_command(
    OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/include
    COMMAND mkdir -p ${CMAKE_CURRENT_BINARY_DIR}/include/genavb/_os
    COMMAND cp -a ${common_headers} ${CMAKE_CURRENT_BINARY_DIR}/include/genavb
    COMMAND cp -a ${os_headers} ${CMAKE_CURRENT_BINARY_DIR}/include/genavb/_os
