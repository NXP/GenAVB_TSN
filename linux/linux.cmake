...
if(CONFIG_GENAVB_TSN_AVTP OR CONFIG_GENAVB_TSN_AVDECC OR CONFIG_GENAVB_TSN_MAAP)
  set(avb avb)
endif()

if(CONFIG_GENAVB_TSN_GPTP OR CONFIG_GENAVB_TSN_SRP OR CONFIG_GENAVB_TSN_MANAGEMENT)
  set(tsn tsn)
endif()
...
unset(HAVE_SO_TIMESTAMPING_FLAGS CACHE)
check_struct_has_member("struct so_timestamping" flags linux/net_tstamp.h HAVE_SO_TIMESTAMPING_FLAGS LANGUAGE C)

if(NOT HAVE_SO_TIMESTAMPING_FLAGS)
  message(WARNING "Toolchain using kernel headers without virtual PHC support")
else()
  genavb_target_add_compile_definitions(TARGET ${tsn} DEFS HAVE_VIRTUAL_PHC_SUPPORT)
  genavb_target_add_compile_definitions(TARGET ${avb} DEFS HAVE_VIRTUAL_PHC_SUPPORT)
  genavb_target_add_compile_definitions(TARGET genavb DEFS HAVE_VIRTUAL_PHC_SUPPORT)
endif()
...
genavb_target_add_srcs(TARGET ${avb} SRCS net_std.c net_std_socket_filters.c net_avb.c shmem.c)
