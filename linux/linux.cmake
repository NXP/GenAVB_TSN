...
if(CONFIG_AVTP OR CONFIG_AVDECC OR CONFIG_MAAP OR CONFIG_SRP)
  set(avb avb)
endif()
...
genavb_add_executable(NAME ${fgptp}
  SRCS
  fgptp_main.c
  stdlib.c
  string.c
...
genavb_add_dependencies(TARGET ${fgptp} DEP modules-dir)
...
add_custom_target(stack-core
  DEPENDS ${avb} ${fgptp} ${genavb}
  )

if(CONFIG_NET_STD)
  add_definitions(-DCONFIG_LIB_DEFAULT_NET=NET_STD -DCONFIG_1733_DEFAULT_NET=NET_STD)
  genavb_target_add_srcs(TARGET ${avb} SRCS net_std.c net_std_socket_filters.c rtnetlink.c fqtss.c fqtss_std.c fdb_std.c)
  genavb_target_add_srcs(TARGET ${fgptp} SRCS net_std.c net_std_socket_filters.c)
...
elseif(CONFIG_NET_XDP)
  add_definitions(-DCONFIG_AVB_DEFAULT_NET=NET_STD -DCONFIG_FGPTP_DEFAULT_NET=NET_STD)
  genavb_target_add_srcs(TARGET ${avb} SRCS net_std.c net_std_socket_filters.c rtnetlink.c fqtss.c fqtss_std.c fdb_std.c)
  genavb_target_add_srcs(TARGET ${fgptp} SRCS net_std.c net_std_socket_filters.c)
  genavb_target_add_srcs(TARGET genavb1733 SRCS net_std.c net_std_socket_filters.c rtnetlink.c fqtss.c fqtss_std.c)
else()
  genavb_target_add_srcs(TARGET ${avb} SRCS net_avb.c shmem.c fqtss.c fqtss_avb.c)
  genavb_target_add_srcs(TARGET ${fgptp} SRCS net_avb.c shmem.c)
...
if(CONFIG_AVTP)
  ...
  genavb_target_add_srcs(TARGET ${fgptp} SRCS timer_media.c)
endif()

if(CONFIG_SJA1105)
  include_directories("${NXP_SWITCH_PATH}/drivers/modules")
  genavb_target_add_srcs(TARGET ${avb} SRCS fqtss_sja.c fdb_sja.c rtnetlink.c)
endif()
