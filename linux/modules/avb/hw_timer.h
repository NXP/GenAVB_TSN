...
struct hw_timer_dev {
	...
	unsigned int (*irq_ack)(struct hw_timer_dev *dev, unsigned int *cycles, unsigned int *dcycles);
	unsigned int (*elapsed)(struct hw_timer_dev *dev, unsigned int cycles);
	void (*start)(struct hw_timer_dev *dev);
	void (*stop)(struct hw_timer_dev *dev);
	void (*set_period)(struct hw_timer_dev *dev, unsigned long period_us);
	int irq;
