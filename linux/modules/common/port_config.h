...
/* DSA tagging/untagging support in the kernel module is disabled by default. */
#define CFG_DSA_TAG_SUPPORT	0
#define CFG_ETHERTYPE_DSA	0x0000 /* Should be set to the right DSA tag (ethertype) when CFG_DSA_TAG_SUPPORT is enabled. */
