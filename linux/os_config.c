...
#define CLOCK_ENDPOINT_GPTP_0_DEFAULT		"/dev/ptp0"	/* domain 0 target clock */
#define CLOCK_ENDPOINT_GPTP_1_DEFAULT		"sw_clock"	/* domain 1 target clock */
#define CLOCK_ENDPOINT_LOCAL_DEFAULT		"/dev/ptp0"

#define CLOCK_BRIDGE_GPTP_0_DEFAULT		"sw_clock"		/* domain 0 target clock */
#define CLOCK_BRIDGE_GPTP_1_DEFAULT		"sw_clock"		/* domain 1 target clock */
...
void os_net_config_parse(struct os_net_config *net_config)
{
	...
	net_config->enabled_modes_flag |= NET_MODE_TO_FLAG(net_config->maap_net_mode);
