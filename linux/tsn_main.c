...
#if defined(CONFIG_GENAVB_TSN_GPTP) || defined(CONFIG_GENAVB_TSN_SRP)
...
#if defined(CONFIG_GENAVB_TSN_MANAGEMENT) || defined(CONFIG_GENAVB_TSN_GPTP) || defined(CONFIG_GENAVB_TSN_SRP)
	if (is_bridge) {
