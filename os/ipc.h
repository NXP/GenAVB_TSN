 ...
 * Copyright 2017-2019, 2021, 2023, 2025 NXP
 *
 ...
 * \return	none.
 */
int ipc_rx_init(struct ipc_rx *rx, ipc_id_t id, void (*func)(struct ipc_rx const *rx, struct ipc_desc *desc), unsigned long priv);
