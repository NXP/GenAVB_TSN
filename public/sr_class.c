...
static const unsigned int _prio_to_pcp[SR_PRIO_MAX] = {SR_CLASS_HIGH_PCP, SR_CLASS_LOW_PCP};
static const unsigned int _prio_to_id[SR_PRIO_MAX] = {SR_CLASS_HIGH_ID, SR_CLASS_LOW_ID};
