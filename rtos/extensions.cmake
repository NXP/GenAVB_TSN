...
function(genavb_install)
  if(POLICY CMP0177)
    cmake_path(SET TMP_INCLUDE_DIR NORMALIZE ${INCLUDE_DIR})
  else()
    set(TMP_INCLUDE_DIR ${INCLUDE_DIR})
  endif()
  install(DIRECTORY DESTINATION ${TMP_INCLUDE_DIR}/genavb/_os)
  install(DIRECTORY include/genavb DESTINATION ${TMP_INCLUDE_DIR})
  install(DIRECTORY include/${TARGET_OS}/_os DESTINATION ${TMP_INCLUDE_DIR}/genavb)
endfunction()
