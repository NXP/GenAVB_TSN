...
#else
static inline void hsr_socket_unbind(struct net_socket *sock) { }
static inline int hsr_socket_bind(struct net_socket *sock, struct net_address *addr) { return -1; }
static inline void hsr_socket_disconnect(struct logical_port *port, struct net_socket *sock) { }
static inline int hsr_socket_connect(struct logical_port *port, struct net_socket *sock, struct net_address *addr) { return -1; }
#endif
