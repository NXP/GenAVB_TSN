...
static struct ipc_channel ipc_channel[IPC_ID_MAX] = {
	[IPC_MEDIA_STACK_AVDECC].type = IPC_TYPE_SINGLE_READER_WRITER,
	[IPC_AVDECC_MEDIA_STACK].type = IPC_TYPE_SINGLE_READER_WRITER,

	[IPC_CONTROLLER_AVDECC].type = IPC_TYPE_SINGLE_READER_WRITER,
	[IPC_AVDECC_CONTROLLER].type = IPC_TYPE_SINGLE_READER_WRITER,
	[IPC_AVDECC_CONTROLLER_SYNC].type = IPC_TYPE_SINGLE_READER_WRITER,

	[IPC_CONTROLLED_AVDECC].type = IPC_TYPE_SINGLE_READER_WRITER,
	[IPC_AVDECC_CONTROLLED].type = IPC_TYPE_SINGLE_READER_WRITER,

	[IPC_MEDIA_STACK_MSRP].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MSRP_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MSRP_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_MVRP].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MVRP_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MVRP_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_CLOCK_DOMAIN].type = IPC_TYPE_MANY_WRITERS,
	[IPC_CLOCK_DOMAIN_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_CLOCK_DOMAIN_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_MAAP].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MAAP_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MAAP_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_GPTP].type = IPC_TYPE_MANY_WRITERS,
	[IPC_GPTP_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_GPTP_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_AVTP].type = IPC_TYPE_MANY_WRITERS,
	[IPC_AVTP_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_AVTP_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_AVTP_STATS].type = IPC_TYPE_SINGLE_READER_WRITER,

	[IPC_AVDECC_AVTP].type = IPC_TYPE_SINGLE_READER_WRITER,
	[IPC_AVTP_AVDECC].type = IPC_TYPE_SINGLE_READER_WRITER,

	[IPC_MEDIA_STACK_MAC_SERVICE].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MAC_SERVICE_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MAC_SERVICE_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_GPTP_BRIDGE].type = IPC_TYPE_MANY_WRITERS,
	[IPC_GPTP_BRIDGE_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_GPTP_BRIDGE_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_MSRP_BRIDGE].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MSRP_BRIDGE_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MSRP_BRIDGE_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_MVRP_BRIDGE].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MVRP_BRIDGE_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MVRP_BRIDGE_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,

	[IPC_MEDIA_STACK_MAC_SERVICE_BRIDGE].type = IPC_TYPE_MANY_WRITERS,
	[IPC_MAC_SERVICE_BRIDGE_MEDIA_STACK].type = IPC_TYPE_MANY_READERS,
	[IPC_MAC_SERVICE_BRIDGE_MEDIA_STACK_SYNC].type = IPC_TYPE_MANY_READERS,
};
