...
__init uint32_t msgintr_msix_msgaddr(void *base, uint8_t channel)
{
...
__init uint32_t msgintr_init_vector(void *base, uint8_t channel, void (*callback)(void *data), void *data)
{
...
__exit void msgintr_reset_vector(void *base, uint8_t channel)
{
	MSGINTR_Type *msgintr_base = (MSGINTR_Type *) base;
	int index;
...
__init int msgintr_init(void) { return 0; }
__exit void msgintr_exit(void) {}
__init uint32_t msgintr_init_vector(void *base, uint8_t channel, void (*callback)(void *data), void *data) { return 0; }
__exit  void msgintr_reset_vector(void *base, uint8_t channel) { }
...
__init uint32_t msgintr_init_vector(void *base, uint8_t channel, void (*callback)(void *data), void *data) { return 0; }
__exit void msgintr_reset_vector(void *base, uint8_t channel) { }
__init uint32_t msgintr_msix_msgaddr(void *base, uint8_t channel) { return 0; }
