...
void mtimer_set_callback(struct mtimer_dev *dev, void (*cb)(void *data), void *data);
#else
...
static inline void mtimer_set_callback(struct mtimer_dev *dev, void (*cb)(void *data), void *data)
{
	return;
}
#endif /* CONFIG_GENAVB_TSN_AVTP */
