...
int net_tx_set_callback(struct net_tx *tx, void (*callback)(void *), void *data)
{
...
int net_port_traffic_class_set(unsigned int port_id, struct genavb_traffic_class_config *config)
{
	...
	port_set_priority_to_traffic_class_map(port, QOS_TRAFFIC_CLASS_MAX, QOS_SR_CLASS_MAX, config->tc);
