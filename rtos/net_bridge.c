...
static int mac_learn_rx(struct net_rx_ctx *net, struct net_rx_desc *desc, struct net_port *phys_port)
{
...
__init static int __bridge_init(struct net_bridge *bridge)
{
