...
__init int enetc_ep_init(struct net_port *port)
{
	...
	clock_id_remap(port->clock_local, OS_CLOCK_LOCAL_BR_0);
	clock_id_remap(port->clock_gptp[0], OS_CLOCK_GPTP_BR_0_0);
	clock_id_remap(port->clock_gptp[1], OS_CLOCK_GPTP_BR_0_1);
#endif
