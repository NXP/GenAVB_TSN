/*
 * Copyright 2017-2019, 2021, 2023, 2026 NXP
 *
...
#else
static inline void ptp_socket_unbind(struct net_socket *sock) { }
static inline int ptp_socket_bind(struct net_socket *sock, struct net_address *addr) { return -1; }
static inline void ptp_socket_disconnect(struct logical_port *port, struct net_socket *sock) { }
static inline int ptp_socket_connect(struct logical_port *port, struct net_socket *sock, struct net_address *addr) { return -1; }
static inline void ptp_tx_ts(struct net_port *phys_port, u64 ts, u32 priv) { }
#endif
